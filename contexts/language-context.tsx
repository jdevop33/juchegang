...
const translations = {
  ...
  aptDownFilesDesc: "Inside the 9GB leak revealed at DEF CON 2025: tools, ops data, attribution puzzles, and defensive takeaways.",
    ...
    // North Korea Deception Content (English)
    northKoreaDeceptionTitle: "The North Korea Deception: Manufactured Threats and the War Machine",
    northKoreaDeceptionSubtitle: "How threat inflation, media pipelines, and frozen-conflict capitalism sustain an imperial security architecture.",
  ...
  aptDownFilesDesc: "DEF CON 2025에서 공개된 9GB 유출 내부: 도구, 작전 데이터, 귀속 퍼즐, 방어 시사점.",
    ...
    // North Korea Deception Content (Korean)
    northKoreaDeceptionTitle: "북조선 기만: 조작된 위협과 전쟁 기계",
    northKoreaDeceptionSubtitle: "위협 부풀리기, 언론 파이프라인, 그리고 동결 갈등 자본주의가 어떻게 제국주의 안보 구조를 유지하는가.",
