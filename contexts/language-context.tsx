...
const translations = {
  en: {
    ...
    readNKDeception: "Read: The DPRK Narrative",
    ...
    natoExpansionDesc: "President Vladimir Putin's 2007 Munich speech, declassified assurances, expansion waves, crisis precedents, and U.S. policy doctrine.",
    northKoreaDeceptionTitle: "The DPRK Narrative: How Manufactured Threats Fund the Imperial War Machine",
  ...
  falseFlagOpsTitle: "False Flag Cyber Operations and DPRK APT Mimicry",
  ...
  aptDownFilesDesc: "Inside the 9GB leak revealed at DEF CON 2025: tools, ops data, attribution puzzles, and defensive takeaways.",
    ...
    sanctionsWarfareDesc: "Documented death tolls, declassified intentions, and academic consensus on sanctions as modern siege warfare across Cuba, Iraq, Venezuela, Iran, Syria and the DPRK.",
    ...
    putinMunichTitle: "President Vladimir Putin's 2007 Munich security conference speech reveals deep Russian grievances",
    ...
    northKoreaSanctions: "DPRK Agricultural Constraints under Sanctions", 
    ...
    northKoreaSanctionsContent: "Current UN sanctions, tightened dramatically in 2016-2017, have recreated pre-famine conditions by restricting oil imports essential for agriculture. The DPRK receives only 500,000 barrels of refined petroleum annually—equivalent to one day of South Korean consumption—crippling fertilizer production and agricultural machinery. The sanctions regime systematically obstructs humanitarian aid delivery, with WFP funding dropping to only $15 million of the $50 million yearly need. By 2021, DPRK officials were again using 'Arduous March' terminology, signaling return to famine conditions.",
    ...
    sanctionsPatternContent: "See how sanctions work: 1. Create Problems: Economic pressure creates crisis. 2. Amplify Suffering: Cause food and medicine shortages. 3. Shift Blame: Assign responsibility to the targeted government. 4. Justify Intervention: Propose 'humanitarian' intervention. This happened identically in Cuba, Iran, Venezuela, Syria. Always the same pattern.",
    ...
    falseFlagGlobalPatterns: "Cases like Olympic Destroyer demonstrated forged Lazarus‑style signatures; operations such as TV5Monde and Guccifer 2.0 leveraged false personas; and meta‑espionage has ridden others' infrastructure. Across actors, obfuscation can involve contractor networks and APT persona blending. The community's response emphasizes behavioral analysis (MITRE ATT&CK), multi‑source verification, and collaboration, as language strings and simple IOCs are easy to forge.",
