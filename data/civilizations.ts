...
export const civilizations: Civilization[] = [
  ...
  { name: "Korea (North & South)", flag: "🇰🇵🇰🇷", civYear: -2333, stateYear: 1948, gdp: 1710, gdpRank: 13, note: "Gojoseon ~2333 BC. Unified kingdom from 668 AD. One people, one 4,000-year civilization — divided by two American colonels in 30 minutes in 1945. The line is temporary." },
