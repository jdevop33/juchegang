    ...
    <article className="container mx-auto px-4 py-16">
      <div className="max-w-4xl mx-auto prose prose-lg dark:prose-invert">
        ...
        <div className="bg-sovereign-gold/10 border border-sovereign-gold/30 rounded-lg p-6 mb-12">
          ...
          <div className="not-prose grid grid-cols-2 md:grid-cols-3 gap-4">
            <div className="bg-muted/30 border border-sovereign-gold/20 rounded-lg p-4 text-center">
              ...
              <p className="text-sm text-cream-muted mt-1">Conformed to Obviously Wrong Answers (Asch)</p>
            </div>
            <div className="bg-muted/30 border border-korean-red/20 rounded-lg p-4 text-center">
              ...
              <p className="text-sm text-cream-muted mt-1">Administered Maximum 450V Shock (Milgram)</p>
            </div>
            <div className="bg-muted/30 border border-sovereign-gold/20 rounded-lg p-4 text-center">
              <p className="text-3xl font-bold text-sovereign-gold">8</p>
              <p className="text-sm text-cream-muted mt-1">Symptoms of Groupthink (Janis)</p>
            </div>
            <div className="bg-muted/30 border border-korean-red/20 rounded-lg p-4 text-center">
              <p className="text-3xl font-bold text-korean-red">20M</p>
              <p className="text-sm text-cream-muted mt-1">Dead from WWI Sleepwalking</p>
            </div>
            <div className="bg-muted/30 border border-sovereign-gold/20 rounded-lg p-4 text-center">
              <p className="text-3xl font-bold text-sovereign-gold">92.5%</p>
              <p className="text-sm text-cream-muted mt-1">Obeyed When Distanced from Consequences</p>
            </div>
            <div className="bg-muted/30 border border-korean-red/20 rounded-lg p-4 text-center">
              <p className="text-3xl font-bold text-korean-red">1</p>
              <p className="text-sm text-cream-muted mt-1">Dissenter Needed to Break the Spell</p>
            </div>
          </div>
        </div>
        ...
        <div className="not-prose my-8 p-6 bg-sovereign-gold/5 border-l-4 border-sovereign-gold rounded-r-lg">
          ...
          <p className="text-cream-muted text-sm mt-3">&mdash; J Panda, White Tiger Publications</p>
        </div>
        ...
        <section className="mb-12">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-sm text-cream-muted uppercase tracking-widest">Chapter</span>
          </div>
          <h2 className="text-3xl font-bold mb-2">The Groupthink Machine</h2>
          <p className="text-lg text-cream-muted italic mb-6">How Irving Janis Decoded Elite Stupidity</p>
          ...
          <blockquote className="border-l-4 border-sovereign-gold pl-6 my-8 italic text-sovereign-gold text-xl">
            ...
            <footer className="text-sm text-cream-muted mt-2 not-italic">&mdash; Irving Janis, 1972</footer>
          </blockquote>
          ...
          <div className="not-prose my-8 p-6 bg-sovereign-gold/5 border-l-4 border-sovereign-gold rounded-r-lg">
            <p className="text-cream/90 leading-relaxed font-semibold">
        ...
        <section className="mb-12">
          ...
          <p className="text-lg text-cream-muted italic mb-6">Asch&rsquo;s Conformity Experiments &amp; Why Smart People Lie</p>
          ...
          <div className="not-prose my-8 p-8 bg-korean-red/5 border-l-4 border-korean-red rounded-r-lg text-center">
            ...
            <p className="text-lg text-cream/90 font-semibold">of participants conformed at least once to an obviously wrong answer</p>
            <p className="text-sm text-cream-muted mt-2">Average conformity rate across all critical trials: 36.8% &bull; Only 24% never conformed at all</p>
          </div>
          ...
          <blockquote className="border-l-4 border-sovereign-gold pl-6 my-8 italic text-sovereign-gold text-xl">
            ...
            <footer className="text-sm text-cream-muted mt-2 not-italic">&mdash; Solomon Asch, 1955</footer>
          </blockquote>
        ...
        <section className="mb-12">
          ...
          <p className="text-lg text-cream-muted italic mb-6">Milgram&rsquo;s Obedience Studies &amp; the Banality of Evil</p>
          ...
          <div className="not-prose my-8 p-8 bg-korean-red/5 border-l-4 border-korean-red rounded-r-lg text-center">
            ...
            <p className="text-lg text-cream/90 font-semibold">of participants administered the maximum 450-volt shock</p>
            <p className="text-sm text-cream-muted mt-2">100% went to at least 300 volts</p>
          </div>
          ...
          <blockquote className="border-l-4 border-sovereign-gold pl-6 my-8 italic text-sovereign-gold text-xl">
            ...
            <footer className="text-sm text-cream-muted mt-2 not-italic">&mdash; Stanley Milgram, 1974</footer>
          </blockquote>
        ...
        <section className="mb-12">
          ...
          <p className="text-lg text-cream-muted italic mb-6">Deindividuation &amp; the Death of Personal Accountability</p>
        ...
        <section className="mb-12">
          ...
          <p className="text-lg text-cream-muted italic mb-6">How Europe Stumbled Into WWI Without Meaning To</p>
          ...
          <blockquote className="border-l-4 border-sovereign-gold pl-6 my-8 italic text-sovereign-gold text-xl">
            ...
            <footer className="text-sm text-cream-muted mt-2 not-italic">&mdash; Christopher Clark, <em>The Sleepwalkers</em></footer>
          </blockquote>
          ...
          <div className="not-prose my-8 p-8 bg-korean-red/5 border-l-4 border-korean-red rounded-r-lg text-center">
            ...
            <p className="text-lg text-cream/90">The seeds of an even worse war planted. All because nobody in any of the decision-making rooms could step outside their own assumptions long enough to see what they were actually building.</p>
          </div>
        ...
        <section className="mb-12">
          ...
          <p className="text-lg text-cream-muted italic mb-6">Washington&rsquo;s Self-Licking Ice Cream Cone</p>
          ...
          <blockquote className="border-l-4 border-sovereign-gold pl-6 my-8 italic text-sovereign-gold text-xl">
            ...
            <footer className="text-sm text-cream-muted mt-2 not-italic">&mdash; Stephen Walt, <em>Foreign Policy</em>, 2022</footer>
          </blockquote>
        ...
        <section className="mb-12">
          ...
          <p className="text-lg text-cream-muted italic mb-6">Dunning-Kruger at a Civilizational Scale</p>
          ...
          <blockquote className="border-l-4 border-sovereign-gold pl-6 my-8 italic text-sovereign-gold text-xl">
            ...
            <footer className="text-sm text-cream-muted mt-2 not-italic">&mdash; Stephen Walt, <em>The Myth of American Exceptionalism</em></footer>
          </blockquote>
        ...
        <section className="mb-12">
          ...
          <p className="text-lg text-cream-muted italic mb-6">Drunken Hubris + Groupthink + Nuclear Weapons = &hellip;</p>
          ...
          <div className="not-prose my-8 p-8 bg-korean-red/5 border-l-4 border-korean-red rounded-r-lg">
            ...
            <div className="space-y-2 text-cream/90 font-mono text-sm md:text-base">
              <p>&nbsp;&nbsp;75% conformity rate <span className="text-cream-muted">(Asch)</span></p>
              <p>+ 65% blind obedience <span className="text-cream-muted">(Milgram)</span></p>
              <p>+ Groupthink consensus machine <span className="text-cream-muted">(Janis)</span></p>
              <p>+ Deindividuated moral abdication <span className="text-cream-muted">(Le Bon)</span></p>
              <p>+ Self-perpetuating elite consensus <span className="text-cream-muted">(The Blob)</span></p>
              <p>+ Civilizational Dunning-Kruger <span className="text-cream-muted">(Foam Finger)</span></p>
        ...
        <div className="text-center mt-16 mb-8">
          ...
          <p className="text-cream-muted text-sm">iPurpose Consulting &bull; Victoria, BC &bull; February 2026</p>
