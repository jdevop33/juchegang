  ...
  return (
    <main className="min-h-screen bg-river-depths text-cream">
      ...
      <section className="relative w-full" style={{ height: "60vh", minHeight: "400px" }}>
        ...
        <div className="absolute bottom-0 left-0 right-0 px-6 pb-12 md:pb-16">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="mt-4 text-cream/80 text-lg md:text-xl max-w-3xl">
      ...
      <article className="max-w-4xl mx-auto px-6 py-12 md:py-16">
        ...
        {/* Table of Contents */}
        <nav className="mb-16 p-8 rounded-xl border border-river-current bg-river-current/20">
          <h2 className="text-xl font-bold text-sovereign-gold mb-6 font-[family-name:var(--font-heading)]">
            Table of Contents
          </h2>
          <ol className="space-y-3 text-cream/80">
            <li>
              <a href="#introduction" className="hover:text-sovereign-gold transition-colors">
                I. Introduction
              </a>
            </li>
            <li>
              <a href="#ontological-foundation" className="hover:text-sovereign-gold transition-colors">
                II. The Ontological Foundation of Rights in the Juche Doctrine
              </a>
            </li>
            <li>
              <a href="#legislative-evolution" className="hover:text-sovereign-gold transition-colors">
                III. Legislative Evolution and the Socialist Human Rights System
              </a>
            </li>
            <li>
              <a href="#contradictions" className="hover:text-sovereign-gold transition-colors">
                IV. Contradictions and the &ldquo;Objective Reality&rdquo; of State Control
              </a>
            </li>
            <li>
              <a href="#epistemology-defection" className="hover:text-sovereign-gold transition-colors">
                V. The Epistemology of Defection: Navigating the Human Rights Industry
              </a>
            </li>
            <li>
              <a href="#world-police" className="hover:text-sovereign-gold transition-colors">
                VI. The Global &ldquo;World Police&rdquo; and the Erosion of International Law
              </a>
            </li>
            <li>
              <a href="#military-industrial" className="hover:text-sovereign-gold transition-colors">
                VII. The Military-Industrial Complex and the &ldquo;Frozen Conflict&rdquo; Model
              </a>
            </li>
            <li>
              <a href="#sanctions-scarcity" className="hover:text-sovereign-gold transition-colors">
                VIII. Sanctions, Scarcity, and the Social Safety Net Paradox
              </a>
            </li>
            <li>
              <a href="#disconnect-29-million" className="hover:text-sovereign-gold transition-colors">
                IX. The Disconnect of the 29 Million
              </a>
            </li>
            <li>
              <a href="#synthesis" className="hover:text-sovereign-gold transition-colors">
                X. Synthesis: Cutting Through the Propaganda
              </a>
            </li>
            <li>
              <a href="#future-outlook" className="hover:text-sovereign-gold transition-colors">
                XI. Future Outlook: The Stalemate of the 21st Century
              </a>
            </li>
            <li>
              <a href="#works-cited" className="hover:text-sovereign-gold transition-colors">
                XII. Works Cited
              </a>
            </li>
          </ol>
        ...
        <h2
          id="introduction"
          className="text-3xl md:text-4xl font-bold text-cream mb-6 mt-16 font-[family-name:var(--font-heading)]"
        >
          I. Introduction
        </h2>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-river-current">
                <th className="text-left py-3 px-4 text-sovereign-gold font-semibold">Philosophical Domain</th>
                <th className="text-left py-3 px-4 text-sovereign-gold font-semibold">Juche Definition of Human Rights</th>
                <th className="text-left py-3 px-4 text-sovereign-gold font-semibold">Implication for State Policy</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">Core Essence</td>
                <td className="py-3 px-4 text-cream">Independence as the &ldquo;life and soul&rdquo; of man</td>
                <td className="py-3 px-4 text-cream">Priority on national defense and sovereignty</td>
              </tr>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">Subject of Rights</td>
                <td className="py-3 px-4 text-cream">The collective masses of the people</td>
                <td className="py-3 px-4 text-cream">Emphasis on collectivism over individualism</td>
              </tr>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">National Dimension</td>
                <td className="py-3 px-4 text-cream">Human rights = National Sovereignty</td>
                <td className="py-3 px-4 text-cream">Rejection of external human rights intervention</td>
              </tr>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">Foundation of Rights</td>
                <td className="py-3 px-4 text-cream">Socio-political independence is the prerequisite</td>
                <td className="py-3 px-4 text-cream">State must be the &ldquo;master of politics&rdquo; first</td>
              </tr>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">Economic Rights</td>
                <td className="py-3 px-4 text-cream">The &ldquo;Right to Existence&rdquo; through labor</td>
                <td className="py-3 px-4 text-cream">State responsibility for jobs, food, and housing</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="overflow-x-auto my-8">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-river-current">
                <th className="text-left py-3 px-4 text-sovereign-gold font-semibold">Constitutional Domain</th>
                <th className="text-left py-3 px-4 text-sovereign-gold font-semibold">Key Article Claims</th>
                <th className="text-left py-3 px-4 text-sovereign-gold font-semibold">Legislative Basis</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">Political Rights</td>
                <td className="py-3 px-4 text-cream">Sovereignty resides in workers and peasants (Art 4); universal suffrage (Art 6)</td>
                <td className="py-3 px-4 text-cream">Law on the Election of Deputies</td>
              </tr>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">Economic Rights</td>
                <td className="py-3 px-4 text-cream">State ensures food, clothing, and housing (Art 25); 8-hour workday (Art 30)</td>
                <td className="py-3 px-4 text-cream">Socialist Labour Law</td>
              </tr>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">Cultural Rights</td>
                <td className="py-3 px-4 text-cream">Universal 12-year compulsory education (Art 45); free education (Art 47)</td>
                <td className="py-3 px-4 text-cream">Law on General Education</td>
              </tr>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">Public Health</td>
                <td className="py-3 px-4 text-cream">Universal free medical service; preventive medicine (Art 56)</td>
                <td className="py-3 px-4 text-cream">Public Health Law (1980)</td>
              </tr>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">Special Protection</td>
                <td className="py-3 px-4 text-cream">Equal status for women (Art 77); protection of marriage and family (Art 78)</td>
                <td className="py-3 px-4 text-cream">Law on the Protection of Women</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="overflow-x-auto my-8">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-river-current">
                <th className="text-left py-3 px-4 text-sovereign-gold font-semibold">Reported Violation Type</th>
                <th className="text-left py-3 px-4 text-sovereign-gold font-semibold">Mechanism of State Action</th>
                <th className="text-left py-3 px-4 text-sovereign-gold font-semibold">Human Impact</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">Crimes Against Humanity</td>
                <td className="py-3 px-4 text-cream">Murder, enslavement, torture, and rape</td>
                <td className="py-3 px-4 text-cream">Shocking atrocities &ldquo;similar to Nazi Germany&rdquo;</td>
              </tr>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">Denial of Freedoms</td>
                <td className="py-3 px-4 text-cream">Absolute control over speech, press, and religion</td>
                <td className="py-3 px-4 text-cream">No detected critical expression goes unpunished</td>
              </tr>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">Right to Food</td>
                <td className="py-3 px-4 text-cream">Prioritization of military/elites over the masses</td>
                <td className="py-3 px-4 text-cream">Avoidable starvation and stunted generations</td>
              </tr>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">Forced Repatriation</td>
                <td className="py-3 px-4 text-cream">Cooperation with China to return fleeing refugees</td>
                <td className="py-3 px-4 text-cream">Torture, forced abortions, and sexual violence</td>
              </tr>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">Extrajudicial Killing</td>
                <td className="py-3 px-4 text-cream">Shoot-to-kill orders at the northern border</td>
                <td className="py-3 px-4 text-cream">Immediate execution for attempted departure</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="overflow-x-auto my-8">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-river-current">
                <th className="text-left py-3 px-4 text-sovereign-gold font-semibold">Information Reliability Factor</th>
                <th className="text-left py-3 px-4 text-sovereign-gold font-semibold">Challenge in Documentation</th>
                <th className="text-left py-3 px-4 text-sovereign-gold font-semibold">Source Evaluation</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">Market Pressure</td>
                <td className="py-3 px-4 text-cream">Financial rewards for &ldquo;shocking&rdquo; testimonies</td>
                <td className="py-3 px-4 text-cream">Need for cross-verification</td>
              </tr>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">Political Instrumentalization</td>
                <td className="py-3 px-4 text-cream">Use of rights narrative for regime change</td>
                <td className="py-3 px-4 text-cream">Analysis of policy outcomes</td>
              </tr>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">Media Spectacle</td>
                <td className="py-3 px-4 text-cream">Reduction of complex realities to simple images</td>
                <td className="py-3 px-4 text-cream">Use of data over &ldquo;spectacle&rdquo;</td>
              </tr>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">Access Constraints</td>
                <td className="py-3 px-4 text-cream">No direct independent access to the country</td>
                <td className="py-3 px-4 text-cream">Reliance on satellite and leaked data</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="overflow-x-auto my-8">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-river-current">
                <th className="text-left py-3 px-4 text-sovereign-gold font-semibold">US Military Intervention</th>
                <th className="text-left py-3 px-4 text-sovereign-gold font-semibold">Stated Objective</th>
                <th className="text-left py-3 px-4 text-sovereign-gold font-semibold">Reported Civilian Outcome</th>
                <th className="text-left py-3 px-4 text-sovereign-gold font-semibold">Legal Critique</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">Yemen (Operation Rough Rider 2025)</td>
                <td className="py-3 px-4 text-cream">Degrade Houthi capabilities</td>
                <td className="py-3 px-4 text-cream">238-642+ civilians killed</td>
                <td className="py-3 px-4 text-cream">Indiscriminate attack / war crime</td>
              </tr>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">Venezuela (Capture of Maduro 2025)</td>
                <td className="py-3 px-4 text-cream">Law enforcement / anti-trafficking</td>
                <td className="py-3 px-4 text-cream">Abduction of sitting head of state</td>
                <td className="py-3 px-4 text-cream">Breach of Art 2(4) of UN Charter</td>
              </tr>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">Iraq / Syria Coalition Actions</td>
                <td className="py-3 px-4 text-cream">Counter-ISIS / leadership strikes</td>
                <td className="py-3 px-4 text-cream">&ldquo;Untold number&rdquo; of uncounted deaths</td>
                <td className="py-3 px-4 text-cream">Flawed targeting methodology</td>
              </tr>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">Somalia Airstrikes (2020)</td>
                <td className="py-3 px-4 text-cream">Target Al-Shabab militants</td>
                <td className="py-3 px-4 text-cream">7+ civilians killed in residential areas</td>
                <td className="py-3 px-4 text-cream">Inadequate investigations / no redress</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="overflow-x-auto my-8">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-river-current">
                <th className="text-left py-3 px-4 text-sovereign-gold font-semibold">MIC Beneficiary (Post-2022)</th>
                <th className="text-left py-3 px-4 text-sovereign-gold font-semibold">Valuation / Sales Growth</th>
                <th className="text-left py-3 px-4 text-sovereign-gold font-semibold">Mechanism of Profit</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">US Arms Export Share</td>
                <td className="py-3 px-4 text-cream">Rose from 35% to 43%</td>
                <td className="py-3 px-4 text-cream">Global demand from Ukraine conflict</td>
              </tr>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">S&amp;P Aerospace &amp; Defense Index</td>
                <td className="py-3 px-4 text-cream">~90% increase</td>
                <td className="py-3 px-4 text-cream">Outperforming broader market indices</td>
              </tr>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">Palantir Technologies</td>
                <td className="py-3 px-4 text-cream">~3,200% market cap jump</td>
                <td className="py-3 px-4 text-cream">AI-driven surveillance and battlefield data</td>
              </tr>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">155mm Artillery Shells</td>
                <td className="py-3 px-4 text-cream">Production up from 14.4k to 40k/month</td>
                <td className="py-3 px-4 text-cream">Target of 100k/month by 2025</td>
              </tr>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">Anduril Industries</td>
                <td className="py-3 px-4 text-cream">$14B to $30.5B valuation</td>
                <td className="py-3 px-4 text-cream">Expansion into drones and AI</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="overflow-x-auto my-8">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-river-current">
                <th className="text-left py-3 px-4 text-sovereign-gold font-semibold">Domestic Crisis Indicator</th>
                <th className="text-left py-3 px-4 text-sovereign-gold font-semibold">United States Reality (2024-2025)</th>
                <th className="text-left py-3 px-4 text-sovereign-gold font-semibold">DPRK Reality (Sanction-Impacted)</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">Homelessness / Housing</td>
                <td className="py-3 px-4 text-cream">771,480+ homeless; 39% rise in family homelessness</td>
                <td className="py-3 px-4 text-cream">State housing exists but is often dilapidated / lacks fuel</td>
              </tr>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">Healthcare Access</td>
                <td className="py-3 px-4 text-cream">11-18% of adults carry $220B in medical debt</td>
                <td className="py-3 px-4 text-cream">Theoretically free but requires informal payments</td>
              </tr>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">Child Poverty</td>
                <td className="py-3 px-4 text-cream">~150,000 children homeless; 33% annual increase</td>
                <td className="py-3 px-4 text-cream">Orphans used for forced labor in coal mines</td>
              </tr>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">Food Insecurity</td>
                <td className="py-3 px-4 text-cream">42 million on SNAP; benefits don&rsquo;t cover meal costs</td>
                <td className="py-3 px-4 text-cream">68.6% of population food insecure (17.8 million)</td>
              </tr>
              <tr className="border-b border-river-current/30">
                <td className="py-3 px-4 text-cream font-medium">Safety Net Expenditure</td>
                <td className="py-3 px-4 text-cream">18.5% of GDP (lower than peer market nations)</td>
                <td className="py-3 px-4 text-cream">Systemic decline due to sanctions and isolation</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <blockquote className="border-l-4 border-sovereign-gold pl-6 py-4 my-6 bg-river-current/20 rounded-r-lg">
          <p className="text-cream italic text-lg leading-relaxed">
        ...
        <div className="my-8 p-6 rounded-xl border border-sovereign-gold/30 bg-sovereign-gold/10">
          <div className="text-sm text-sovereign-gold font-semibold mb-2">KEY FINDING</div>
        ...
        <div className="border-t border-river-current pt-8">
          <ol className="list-decimal list-outside ml-6 space-y-4 text-cream-muted text-sm leading-relaxed">
            <li>
              <span className="text-cream">UNDERSTANDING-KOREA-9-HUMAN-RIGHTS.pdf</span>
            </li>
            <li>
              ...
              <a
                ...
                className="text-sovereign-gold hover:underline underline-offset-4 break-all"
                target="_blank"
        ...
        {/* Back to Briefings */}
        <div className="mt-16 pt-8 border-t border-river-current">
          <Link
            href="/briefings"
            className="inline-flex items-center gap-2 text-sovereign-gold hover:underline underline-offset-4 transition-colors text-lg"
          >
