      ...
      <div className="max-w-4xl mx-auto prose prose-lg dark:prose-invert">
        ...
        <div className="bg-sovereign-gold/10 border border-sovereign-gold/30 rounded-lg p-6 mb-12">
          ...
          <div className="not-prose grid grid-cols-2 md:grid-cols-3 gap-4">
            <div className="bg-muted/30 border border-sovereign-gold/20 rounded-lg p-4 text-center">
              ...
              <p className="text-sm text-cream-muted mt-1">U.S. Military Installations</p>
            </div>
            <div className="bg-muted/30 border border-korean-red/20 rounded-lg p-4 text-center">
              ...
              <p className="text-sm text-cream-muted mt-1">Infrastructure Outside-the-Fence</p>
            </div>
            <div className="bg-muted/30 border border-sovereign-gold/20 rounded-lg p-4 text-center">
              <p className="text-3xl font-bold text-sovereign-gold">77%</p>
              <p className="text-sm text-cream-muted mt-1">Federal Energy Consumed by DoD</p>
            </div>
            <div className="bg-muted/30 border border-korean-red/20 rounded-lg p-4 text-center">
              <p className="text-3xl font-bold text-korean-red">20&ndash;30 yr</p>
              <p className="text-sm text-cream-muted mt-1">OT System Lifecycle</p>
            </div>
            <div className="bg-muted/30 border border-sovereign-gold/20 rounded-lg p-4 text-center">
              <p className="text-3xl font-bold text-sovereign-gold">18,000+</p>
              <p className="text-sm text-cream-muted mt-1">Orgs Compromised (SolarWinds)</p>
            </div>
            <div className="bg-muted/30 border border-korean-red/20 rounded-lg p-4 text-center">
              <p className="text-3xl font-bold text-korean-red">$2B+</p>
              <p className="text-sm text-cream-muted mt-1">DPRK Crypto Theft</p>
            </div>
          </div>
        </div>
        ...
        <section className="mb-12">
          ...
          <div className="not-prose my-8 overflow-x-auto">
            ...
            <p className="text-xs text-cream-muted mt-2 italic">Table 1: Critical Infrastructure Dependencies for Military Installations</p>
          </div>
          ...
          <div className="not-prose my-8 overflow-x-auto">
            ...
            <p className="text-xs text-cream-muted mt-2 italic">Table 2: IT vs OT Security Model Comparison</p>
          </div>
        ...
        <section className="mb-12">
          ...
          <div className="not-prose my-8 overflow-x-auto">
            ...
            <p className="text-xs text-cream-muted mt-2 italic">Table 3: Nation-State OT Cyber Capabilities Comparison</p>
          </div>
          ...
          <div className="not-prose my-8 overflow-x-auto">
            ...
            <p className="text-xs text-cream-muted mt-2 italic">Table 4: Adversary Strategic Objectives Across the Conflict Spectrum</p>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="not-prose my-8 overflow-x-auto">
            ...
            <p className="text-xs text-cream-muted mt-2 italic">Table 5: Major OT Cyber Operations Timeline</p>
          </div>
        ...
        <section className="mb-12">
          ...
          <div className="not-prose my-8 overflow-x-auto">
            ...
            <p className="text-xs text-cream-muted mt-2 italic">Table 6: Five-Phase OT Vulnerability Management Framework</p>
          </div>
        ...
        <section className="mb-12">
          ...
          <div className="not-prose my-8 overflow-x-auto">
            ...
            <p className="text-xs text-cream-muted mt-2 italic">Table 7: Implementation Roadmap with Success Metrics</p>
          </div>
        ...
        <div className="not-prose mt-16 pt-8 border-t border-muted">
          <div className="grid grid-cols-2 gap-4 text-sm text-cream-muted">
            <div>
              <p className="font-medium text-cream/70">Document ID</p>
              <p>JPANDA-2026-OTSEC-001</p>
            </div>
            <div>
              <p className="font-medium text-cream/70">Version</p>
              <p>1.0</p>
            </div>
            <div>
              <p className="font-medium text-cream/70">Publication Date</p>
              <p>2026-02-03</p>
            </div>
            <div>
              <p className="font-medium text-cream/70">Classification</p>
              <p>UNCLASSIFIED // FOR OFFICIAL USE ONLY</p>
            </div>
            <div>
              <p className="font-medium text-cream/70">Review Date</p>
              <p>2027-02-03</p>
            </div>
            <div>
              <p className="font-medium text-cream/70">Point of Contact</p>
