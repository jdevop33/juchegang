  ...
  return (
    <article className="container mx-auto px-4 pt-28 pb-20 prose prose-invert max-w-4xl">
      <header className="not-prose mb-8">
        <h1 className="text-4xl md:text-5xl font-bold text-cream">{t('bricsTitle')}</h1>
        <p className="text-cream-muted mt-2">{t('bricsSubtitle')}</p>
      </header>
      ...
      <footer className="not-prose mt-6 text-sm text-cream-muted">Send preferred citations to expand this bibliography with direct references.</footer>
