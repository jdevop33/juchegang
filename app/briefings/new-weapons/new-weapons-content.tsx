    ...
    <article className="container mx-auto px-4 py-16">
      <div className="max-w-4xl mx-auto prose prose-lg dark:prose-invert">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-cream-muted/80 max-w-xl mx-auto mt-2">
        ...
        <section className="mb-12">
          ...
          <div className="space-y-3 mb-8 not-prose">
            <div className="flex items-start gap-3 text-lg">
              ...
              <span className="text-cream/90"><strong className="text-sovereign-gold">Nuclear Materials</strong> &mdash; From hafnium bombs to thorium clocks and diamond batteries</span>
            </div>
            <div className="flex items-start gap-3 text-lg">
              <span className="text-sovereign-gold font-bold mt-0.5">2.</span>
              <span className="text-cream/90"><strong className="text-sovereign-gold">Advanced Explosives</strong> &mdash; CL-20, nano-thermites, and reactive materials</span>
            </div>
            <div className="flex items-start gap-3 text-lg">
              <span className="text-sovereign-gold font-bold mt-0.5">3.</span>
              <span className="text-cream/90"><strong className="text-sovereign-gold">Energy Systems</strong> &mdash; Capacitors and power supplies for directed-energy weapons</span>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4 mb-8">
            <div className="bg-muted/30 border-l-4 border-sovereign-gold pl-6 py-4">
              ...
              <p className="text-cream/90">Announced a nuclear diamond battery claiming <strong>10x the energy density of lithium batteries</strong>. While independent verification is pending, the claimed performance represents a generational leap.</p>
            </div>

            <div className="bg-muted/30 border-l-4 border-sovereign-gold pl-6 py-4">
              <h4 className="font-bold text-sovereign-gold mb-2">Infinity Power (UK)</h4>
              <p className="text-cream/90">Reported <strong>60% conversion efficiency</strong> in their diamond betavoltaic design &mdash; a dramatic improvement over the single-digit efficiencies of previous attempts.</p>
            </div>
          </div>
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4 mb-8">
            <div className="bg-muted/30 border-l-4 border-sovereign-gold pl-6 py-4">
              ...
              <p className="text-cream/90">Shaped charges and warheads using CL-20 penetrate 20&ndash;40% deeper into armor and hardened targets compared to current HMX-based explosives.</p>
            </div>

            <div className="bg-muted/30 border-l-4 border-sovereign-gold pl-6 py-4">
              <h4 className="font-bold text-sovereign-gold mb-2">Smaller Warheads, Same Lethality</h4>
              <p className="text-cream/90">A missile using CL-20 can carry a smaller warhead and achieve the same destructive effect. That means longer range, more missiles per platform, and more kills per sortie.</p>
            </div>
          </div>
          ...
          <div className="space-y-4 mb-8">
            <div className="bg-muted/30 border-l-4 border-river-current pl-6 py-4">
              ...
              <p className="text-cream/90">Every bullet, shell, and missile uses a primer containing lead styphnate or lead azide. Nano-thermite primers eliminate lead entirely, reducing toxic exposure for soldiers in training and manufacturing workers.</p>
            </div>

            <div className="bg-muted/30 border-l-4 border-river-current pl-6 py-4">
              <h4 className="font-bold text-river-current dark:text-river-mid mb-2">Tunable Reaction Rates</h4>
              <p className="text-cream/90">By adjusting particle size and composition, engineers can tune nano-thermites from slow-burn incendiaries to ultrafast detonators &mdash; a versatility impossible with traditional energetics.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4 mb-8">
            <div className="bg-muted/30 border-l-4 border-sovereign-gold pl-6 py-4">
              ...
              <p className="text-cream/90">Approximately <strong>$1 of electricity</strong> versus <strong>$100,000+ for a conventional interceptor missile.</strong> In a war where the enemy can launch thousands of cheap drones, this cost asymmetry is existential.</p>
            </div>

            <div className="bg-muted/30 border-l-4 border-sovereign-gold pl-6 py-4">
              <h4 className="font-bold text-sovereign-gold mb-2">Infinite Magazine</h4>
              <p className="text-cream/90">As long as the vehicle has fuel to run its generator, it has ammunition. No resupply convoys. No running out of interceptors. The laser fires as fast as the capacitors can recharge.</p>
            </div>
          </div>
        </section>
        ...
        <div className="text-center mt-12 pt-8 border-t border-sovereign-gold/20">
          <p className="text-sm text-cream-muted tracking-widest uppercase mb-2">J Panda Research</p>
          <p className="text-xs text-sovereign-gold mt-2 italic">&ldquo;Radical Transparency. Real Solutions.&rdquo;</p>
          <p className="text-xs text-cream-muted mt-2">&copy; 2026 J Panda Research. All rights reserved.</p>
        </div>
