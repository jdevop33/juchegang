    ...
    <main className="min-h-[100dvh] bg-river-depths text-cream">
      ...
      <section className="relative w-full" style={{ height: "55vh", minHeight: "380px" }}>
        <Image
          ...
          quality={85}
        />
        <div className="absolute inset-0 bg-gradient-to-t from-river-depths via-river-depths/70 to-river-depths/20" />
        <div className="absolute bottom-0 left-0 right-0 px-6 pb-10 md:pb-14">
          <div className="max-w-3xl mx-auto">
            <p className="text-korean-red text-sm font-bold tracking-widest uppercase mb-3">
              JPanda Editorial
            </p>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight font-[family-name:var(--font-heading)]">
              THE REAL VIRUS
            </h1>
            <p className="mt-3 text-cream/80 text-lg md:text-xl max-w-2xl">
      ...
      <section className="border-b border-river-current">
        <div className="max-w-3xl mx-auto px-6 py-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div>
            <p className="text-korean-red text-xs font-semibold tracking-[0.2em] uppercase">
          ...
          <Link
            href="/briefings"
            className="text-sovereign-gold text-sm hover:underline underline-offset-4"
          >
      ...
      <article className="max-w-3xl mx-auto px-6 py-12 md:py-16">
        {/* Lede */}
        <p className="text-xl md:text-2xl leading-relaxed text-cream/90 mb-8">
        ...
        <p className="text-cream/80 leading-relaxed mb-12">
        ...
        <h2 className="text-3xl font-bold text-sovereign-gold mb-6 font-[family-name:var(--font-heading)]">
        ...
        <blockquote className="border-l-4 border-sovereign-gold pl-6 py-4 my-8 bg-river-current/20 rounded-r-lg">
        ...
        <blockquote className="border-l-4 border-korean-red pl-6 py-4 my-8 bg-korean-red/10 rounded-r-lg">
          <p className="text-cream italic text-lg leading-relaxed">
        ...
        <div className="my-8 p-6 rounded-xl border border-river-current bg-river-current/15">
        ...
        <h2 className="text-3xl font-bold text-korean-red mb-6 font-[family-name:var(--font-heading)]">
          The Debt Spiral
        </h2>
        ...
        <div className="my-8 grid grid-cols-3 gap-4">
          <div className="bg-korean-red/15 border border-korean-red/30 rounded-xl p-5 text-center">
            <div className="text-3xl font-bold text-korean-red">$38T</div>
            <div className="text-xs text-cream-muted mt-1">Total US Debt</div>
          </div>
          <div className="bg-korean-red/15 border border-korean-red/30 rounded-xl p-5 text-center">
            <div className="text-3xl font-bold text-korean-red">$9T</div>
            <div className="text-xs text-cream-muted mt-1">Needs Refinancing</div>
          </div>
          <div className="bg-korean-red/15 border border-korean-red/30 rounded-xl p-5 text-center">
            <div className="text-3xl font-bold text-korean-red">+$360B</div>
            <div className="text-xs text-cream-muted mt-1">Added Interest / Year</div>
          </div>
        </div>
        ...
        <h2 className="text-3xl font-bold text-sovereign-gold mb-6 mt-12 font-[family-name:var(--font-heading)]">
          The Reckoning
        </h2>
        ...
        {/* Closing */}
        <div className="my-12 p-8 rounded-xl border border-sovereign-gold/30 bg-gradient-to-r from-river-current/20 to-river-depths">
          <p className="text-sovereign-gold text-xl font-bold italic mb-6 font-[family-name:var(--font-heading)]">
          ...
          <p className="text-cream/70 mb-1">Sweet dreams.</p>
        </div>

        {/* Author */}
        <div className="mt-12 pt-8 border-t border-river-current">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-full bg-gradient-to-br from-sovereign-gold to-korean-red flex items-center justify-center text-river-depths font-bold text-xl font-[family-name:var(--font-heading)]">
              JP
            </div>
            <div>
              <p className="text-cream font-bold text-lg">JPanda James</p>
              <p className="text-sovereign-gold text-sm italic">aka Panda</p>
              <p className="text-cream-muted text-xs mt-1">The voice that refuses to whisper</p>
            </div>
          </div>
        </div>

        {/* Navigation */}
        <div className="mt-12 pt-8 border-t border-river-current flex flex-col sm:flex-row gap-4 justify-between">
          <Link
            href="/briefings"
