  ...
  <BriefingBanner src="/images/coolgang2.png" alt="AI censorship matrix" aspect="12/5" contain overlay="bottom" />
      <article className="container mx-auto px-4 pt-28 pb-20 prose prose-invert max-w-3xl">
        <header className="not-prose mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-cream">The AI Censorship Matrix</h1>
          <p className="text-cream-muted mt-2">How Western LLMs are programmed to suppress anti‑imperial perspectives</p>
        </header>
        ...
        <footer className="not-prose mt-6 text-sm text-cream-muted">
