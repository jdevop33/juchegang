    ...
    <article className="container mx-auto px-4 py-16">
      <div className="max-w-4xl mx-auto prose prose-lg dark:prose-invert">
        ...
        <div className="not-prose my-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-korean-red/10 border border-korean-red/30 rounded-lg p-6 text-center">
              ...
              <div className="text-cream/70 text-sm">GDP Growth (2024&ndash;2025)</div>
            </div>
            <div className="bg-sovereign-gold/10 border border-sovereign-gold/30 rounded-lg p-6 text-center">
              ...
              <div className="text-cream/70 text-sm">Record Trade Surplus (2024)</div>
            </div>
            <div className="bg-korean-red/10 border border-korean-red/30 rounded-lg p-6 text-center">
              <div className="text-4xl font-bold text-korean-red mb-1">30%</div>
              <div className="text-cream/70 text-sm">Share of Global Growth</div>
            </div>
            <div className="bg-sovereign-gold/10 border border-sovereign-gold/30 rounded-lg p-6 text-center">
              <div className="text-4xl font-bold text-sovereign-gold mb-1">$3.58T</div>
              <div className="text-cream/70 text-sm">Exports (2024), Up 5.9% YoY</div>
            </div>
            <div className="bg-korean-red/10 border border-korean-red/30 rounded-lg p-6 text-center">
              <div className="text-4xl font-bold text-korean-red mb-1">$196B</div>
              <div className="text-cream/70 text-sm">Top 6 Banks Combined Profit</div>
            </div>
            <div className="bg-sovereign-gold/10 border border-sovereign-gold/30 rounded-lg p-6 text-center">
              <div className="text-4xl font-bold text-sovereign-gold mb-1">24 Years</div>
              <div className="text-cream/70 text-sm">Of Failed Collapse Predictions</div>
            </div>
          </div>
        </div>
          ...
          <div className="not-prose my-10">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-sovereign-gold/10 border border-sovereign-gold/30 rounded-lg p-6 text-center">
                ...
                <div className="text-cream/70 text-sm">ICBC Capital Adequacy Ratio</div>
              </div>
              <div className="bg-korean-red/10 border border-korean-red/30 rounded-lg p-6 text-center">
                <div className="text-4xl font-bold text-korean-red mb-1">1.25&ndash;1.34%</div>
                <div className="text-cream/70 text-sm">NPL Ratio (vs EU 2.28&ndash;2.31%)</div>
              </div>
              <div className="bg-sovereign-gold/10 border border-sovereign-gold/30 rounded-lg p-6 text-center">
                <div className="text-4xl font-bold text-sovereign-gold mb-1">210%+</div>
                <div className="text-cream/70 text-sm">Provision Coverage Ratio</div>
              </div>
            </div>
          </div>
        ...
        <section className="mb-12">
            ...
            <table className="w-full text-sm border border-sovereign-gold/20 rounded-lg overflow-hidden">
              ...
              <tbody className="text-cream/80">
                ...
                <tr className="border-t border-sovereign-gold/10">
                  ...
                  <td className="p-3 text-cream/50">Comparable</td>
                </tr>
                <tr className="border-t border-sovereign-gold/10 bg-sovereign-gold/5">
          ...
          <h3 className="text-2xl font-bold mb-4 text-cream">The &ldquo;Hospital Closures&rdquo; Myth</h3>
          ...
          <div className="not-prose my-10">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-sovereign-gold/10 border border-sovereign-gold/30 rounded-lg p-6 text-center">
                ...
                <div className="text-cream/70 text-sm">Hospitals (All-Time High)</div>
              </div>
              <div className="bg-korean-red/10 border border-korean-red/30 rounded-lg p-6 text-center">
                <div className="text-4xl font-bold text-korean-red mb-1">7.23</div>
                <div className="text-cream/70 text-sm">Beds per 1,000 (US: 2.4)</div>
              </div>
              <div className="bg-sovereign-gold/10 border border-sovereign-gold/30 rounded-lg p-6 text-center">
                <div className="text-4xl font-bold text-sovereign-gold mb-1">18x</div>
                <div className="text-cream/70 text-sm">Healthcare Spending Growth Since 2000</div>
              </div>
            </div>
          </div>
          ...
          <div className="not-prose my-10">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-sovereign-gold/10 border border-sovereign-gold/30 rounded-lg p-6 text-center">
                ...
                <div className="text-cream/70 text-sm">Education Spending Growth Since 2000</div>
              </div>
              <div className="bg-korean-red/10 border border-korean-red/30 rounded-lg p-6 text-center">
                <div className="text-4xl font-bold text-korean-red mb-1">16:1</div>
                <div className="text-cream/70 text-sm">Pupil-Teacher Ratio (Global Avg: 24.3:1)</div>
              </div>
              <div className="bg-sovereign-gold/10 border border-sovereign-gold/30 rounded-lg p-6 text-center">
                <div className="text-4xl font-bold text-sovereign-gold mb-1">92.74%</div>
                <div className="text-cream/70 text-sm">Teachers with Bachelor&rsquo;s+</div>
              </div>
            </div>
          </div>
        ...
        <section className="mb-12">
          ...
          <blockquote className="border-l-4 border-sovereign-gold pl-6 my-8 italic text-sovereign-gold text-xl">
            ...
            <footer className="text-sm text-cream-muted mt-2 not-italic">&mdash; Keyu Jin, LSE Economist, 2025 Davos Summer Summit</footer>
          </blockquote>
        </section>
