    ...
    <article className="container mx-auto px-4 py-16">
      <div className="max-w-4xl mx-auto prose prose-lg dark:prose-invert">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-cream-muted max-w-2xl mx-auto italic">
        ...
        <div className="not-prose my-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-korean-red/10 border border-korean-red/30 rounded-lg p-6 text-center">
              ...
              <div className="text-cream/70 text-sm">Of GEO Satellite Signals Unencrypted</div>
            </div>
            <div className="bg-sovereign-gold/10 border border-sovereign-gold/30 rounded-lg p-6 text-center">
              ...
              <div className="text-cream/70 text-sm">Total Equipment Cost</div>
            </div>
            <div className="bg-river-current/20 border border-river-current/30 rounded-lg p-6 text-center">
              <div className="text-4xl font-bold text-cream mb-1">2,711</div>
              <div className="text-cream/70 text-sm">T-Mobile Numbers in 9 Hours</div>
            </div>
          </div>
        </div>
        ...
        <section className="mb-12">
          ...
          <div className="not-prose my-6">
            <div className="bg-river-depths/50 rounded-lg border border-river-current/30 overflow-hidden">
              <div className="bg-river-current/20 px-4 py-3 border-b border-river-current/30">
                <h4 className="text-sm font-bold text-cream uppercase tracking-wider">Hardware Breakdown</h4>
              </div>
          ...
          <div className="bg-river-current/10 border border-river-current/30 rounded-lg p-6 mb-6">
            <h4 className="text-lg font-bold text-cream mb-2">How GEO Satellites Work</h4>
            ...
            <div className="bg-korean-red/10 border border-korean-red/30 rounded-lg p-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-cream/80 text-sm">Non-TV transponders using MPEG scrambling</span>
                  <span className="text-korean-red font-bold">Only 10%</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-cream/80 text-sm">GSE transponders with encryption enabled</span>
                  <span className="text-korean-red font-bold">Only 20%</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-cream/80 text-sm">Links consistently using IPsec</span>
        ...
        <section className="mb-12">
          ...
          <blockquote className="border-l-4 border-korean-red pl-6 my-8 italic text-korean-red text-xl">
            ...
            <span className="block text-sm mt-2 text-cream/60 not-italic">&mdash; Matt Green, Johns Hopkins University</span>
          </blockquote>
          ...
          <blockquote className="border-l-4 border-sovereign-gold pl-6 my-8 italic text-sovereign-gold text-xl">
            ...
            <span className="block text-sm mt-2 text-cream/60 not-italic">&mdash; Nadia Heninger, UC San Diego</span>
          </blockquote>
        ...
        <section className="mb-12">
          ...
          <blockquote className="border-l-4 border-korean-red pl-6 my-8 italic text-korean-red text-xl">
            ...
            <span className="block text-sm mt-2 text-cream/60 not-italic">&mdash; Don&rsquo;t Look Up, ACM CCS 2025</span>
          </blockquote>
          ...
          <div className="not-prose my-8">
            <div className="bg-river-depths/50 rounded-lg border border-river-current/30 overflow-hidden">
              <div className="bg-river-current/20 px-4 py-3 border-b border-river-current/30">
                <h4 className="text-sm font-bold text-cream uppercase tracking-wider">U.S. vs. EU Regulatory Comparison</h4>
              </div>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
        ...
        <section className="mb-12">
          ...
          <blockquote className="border-l-4 border-sovereign-gold pl-6 my-8 italic text-sovereign-gold text-xl">
            ...
            <span className="block text-sm mt-2 text-cream/60 not-italic">&mdash; NSA Advisory, May 2022</span>
          </blockquote>
        ...
        <div className="bg-river-current/10 border border-river-current/30 rounded-lg p-6 mb-8">
          <h3 className="text-lg font-bold text-cream mb-4">Key Sources &amp; References</h3>
