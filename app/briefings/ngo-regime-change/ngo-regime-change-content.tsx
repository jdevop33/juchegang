...
export default function NGORegimeChangeContent() {
  ...
  return (
    <div className="min-h-[100dvh] bg-gradient-to-b from-river-depths via-river-current/20 to-river-depths">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-12 bg-gradient-to-r from-korean-red/30 via-sovereign-gold/30 to-korean-red/30 rounded-2xl p-8 border border-korean-red/20">
          <div className="flex items-start gap-4">
            <AlertTriangle className="w-8 h-8 text-korean-red flex-shrink-0 mt-1" />
            <div>
              <h2 className="text-2xl font-bold text-korean-red mb-3">The Scale of Operations</h2>
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-river-depths/30 rounded p-4">
                  <h3 className="text-korean-red font-bold mb-2">Annual Budgets</h3>
                ...
                <div className="bg-river-depths/30 rounded p-4">
                  <h3 className="text-sovereign-gold font-bold mb-2">Global Reach</h3>
                  <ul className="text-cream/80 text-sm space-y-1">
                ...
                <div className="bg-river-depths/30 rounded p-4">
                  <h3 className="text-sovereign-gold font-bold mb-2">Admission of Purpose</h3>
                  <blockquote className="text-cream/80 text-sm italic">
                    "A lot of what we do today was done covertly 25 years ago by the CIA."
                    <br />
                    <span className="text-sovereign-gold">— Allen Weinstein, NED co-founder, 1991</span>
                  </blockquote>
                </div>
              </div>
            </div>
        ...
        >
          <div className="space-y-6">
            <div className="bg-river-depths/30 rounded-lg p-6">
              <h3 className="text-xl font-bold text-korean-red mb-4">The Network Structure</h3>

              <div className="space-y-6">
                <div className="bg-korean-red/20 rounded-lg p-6 border border-korean-red/30">
                  <h4 className="font-bold text-cream mb-3">Core Organizations</h4>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <h5 className="text-korean-red font-bold mb-2">National Endowment for Democracy (NED)</h5>
                      <ul className="text-cream/80 text-sm space-y-1">
                    ...
                    <div>
                      <h5 className="text-sovereign-gold font-bold mb-2">Funding Network</h5>
                      <ul className="text-cream/80 text-sm space-y-1">
        ...
        >
          <div className="space-y-6">
            <div className="bg-river-depths/30 rounded-lg p-6">
              <h3 className="text-xl font-bold text-river-current mb-4">Color Revolutions to Modern Operations</h3>
        ...
        >
          <div className="space-y-6">
            <div className="bg-river-depths/30 rounded-lg p-6">
              <h3 className="text-xl font-bold text-river-current mb-4">Scholarly Research Exposes the Methods</h3>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-river-current/20 rounded-lg p-6 border border-river-current/30">
                  <h4 className="font-bold text-cream mb-3">Operational Strategy Patterns</h4>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <h5 className="text-river-current font-bold mb-2">Phase 1: Infrastructure</h5>
                      <ul className="text-cream/80 text-sm space-y-1">
                    ...
                    <div>
                      <h5 className="text-river-current font-bold mb-2">Phase 2: Training</h5>
                      <ul className="text-cream/80 text-sm space-y-1">
                    ...
                    <div>
                      <h5 className="text-sovereign-gold font-bold mb-2">Phase 3: Narrative</h5>
                      <ul className="text-cream/80 text-sm space-y-1">
                    ...
                    <div>
                      <h5 className="text-sovereign-gold font-bold mb-2">Phase 4: Action</h5>
                      <ul className="text-cream/80 text-sm space-y-1">
        ...
        >
          <div className="space-y-6">
            <div className="bg-river-depths/30 rounded-lg p-6">
              <h3 className="text-xl font-bold text-sovereign-gold mb-4">Overt and Covert Financial Channels</h3>

              <div className="space-y-6">
                <div className="bg-sovereign-gold/20 rounded-lg p-6 border border-sovereign-gold/30">
                  <h4 className="font-bold text-cream mb-3">Congressional Appropriations (Overt)</h4>
                  <div className="grid md:grid-cols-3 gap-4">
                    <div className="bg-river-depths/20 rounded p-3">
                      <h5 className="text-sovereign-gold font-bold text-lg">$300M</h5>
                      <p className="text-cream/80 text-sm">NED (2023)</p>
                    </div>
                    <div className="bg-river-depths/20 rounded p-3">
                      <h5 className="text-sovereign-gold font-bold text-lg">$3B</h5>
                      <p className="text-cream/80 text-sm">USAID + State Dept</p>
                    </div>
                    <div className="bg-river-depths/20 rounded p-3">
                      <h5 className="text-sovereign-gold font-bold text-lg">&euro;1B+</h5>
                      <p className="text-cream/80 text-sm">EU Programs</p>
                    </div>
                  </div>
                </div>

                <div className="bg-sovereign-gold/20 rounded-lg p-6 border border-sovereign-gold/30">
                  <h4 className="font-bold text-cream mb-3">Private Foundation Layer</h4>
                  <p className="text-cream/90 mb-4">
                  ...
                  <div className="bg-river-depths/20 rounded p-4">
                    <h5 className="text-sovereign-gold font-bold mb-2">Durham Report Revelation</h5>
        ...
        >
          <div className="space-y-6">
            <div className="bg-river-depths/30 rounded-lg p-6">
              <h3 className="text-xl font-bold text-sovereign-gold mb-4">Defensive Measures Worldwide</h3>

              <div className="space-y-6">
                <div className="bg-sovereign-gold/20 rounded-lg p-6 border border-sovereign-gold/30">
                  <h4 className="font-bold text-cream mb-3">Legislative Responses</h4>
                  <p className="text-cream/90 mb-4">
                ...
                <div className="bg-river-current/20 rounded-lg p-6 border border-river-current/30">
                  <h4 className="font-bold text-cream mb-3">Perspectives from Targeted Countries</h4>
                  <div className="space-y-3">
                    <div className="bg-river-depths/20 rounded p-3">
                      <h5 className="text-river-current font-bold mb-1">China's Position</h5>
                      <p className="text-cream/80 text-sm">
                    ...
                    <div className="bg-river-depths/20 rounded p-3">
                      <h5 className="text-korean-red font-bold mb-1">Russian Analysis</h5>
                      <p className="text-cream/80 text-sm">
                    ...
                    <div className="bg-river-depths/20 rounded p-3">
                      <h5 className="text-sovereign-gold font-bold mb-1">Latin American Documentation</h5>
                      <p className="text-cream/80 text-sm">
        ...
        >
          <div className="space-y-6">
            <div className="bg-river-depths/30 rounded-lg p-6">
              <h3 className="text-xl font-bold text-river-current mb-4">Information Warfare Goes Digital</h3>

              <div className="space-y-6">
                <div className="bg-river-current/20 rounded-lg p-6 border border-river-current/30">
                  <h4 className="font-bold text-cream mb-3">Recent Digital Operations</h4>
                ...
                <div className="bg-river-current/20 rounded-lg p-6 border border-river-current/30">
                  <h4 className="font-bold text-cream mb-3">Modern Techniques</h4>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <h5 className="text-river-current font-bold mb-2">Targeting Methods</h5>
                      <ul className="text-cream/80 text-sm space-y-1">
                    ...
                    <div>
                      <h5 className="text-korean-red font-bold mb-2">Youth Focus</h5>
                      <ul className="text-cream/80 text-sm space-y-1">
                  ...
                  <blockquote className="text-river-current italic mt-4 p-4 bg-river-depths/20 rounded">
        ...
        >
          <div className="space-y-6">
            <div className="bg-river-depths/30 rounded-lg p-6">
              <h3 className="text-xl font-bold text-sovereign-gold mb-4">Red Flags vs. Authentic Characteristics</h3>

              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-sovereign-gold/20 rounded-lg p-6 border border-sovereign-gold/30">
                  <h4 className="text-sovereign-gold font-bold mb-3">Authentic Organizations</h4>
                ...
                <div className="bg-korean-red/20 rounded-lg p-6 border border-korean-red/30">
                  <h4 className="text-korean-red font-bold mb-3">Co-option Warning Signs</h4>
                  <ul className="space-y-2 text-cream/80 text-sm">
              ...
              <div className="mt-6 bg-sovereign-gold/20 rounded-lg p-6 border border-sovereign-gold/30">
                <h4 className="text-sovereign-gold font-bold mb-3">Case Study: Maintaining Authenticity</h4>
        ...
        <div className="mt-12 bg-gradient-to-r from-river-current/20 via-river-current/20 to-river-current/20 rounded-xl p-8 border border-river-current/30">
          <h2 className="text-3xl font-bold text-cream mb-6 text-center">The Path Forward</h2>
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-r from-sovereign-gold/20 to-river-current/20 rounded-lg p-6 mb-8 border border-sovereign-gold/20">
              <h3 className="text-sovereign-gold font-bold text-xl mb-3">Supporting Authentic Civil Society</h3>
              ...
              <ul className="text-cream/80 text-left max-w-2xl mx-auto space-y-2">
            ...
            <p className="text-xl text-cream font-medium mb-8">
              Democracy must grow from communities themselves, shaped by their own <span className="text-sovereign-gold">aspirations for justice</span>.
            </p>
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <Link href="/briefings/nato-expansion" className="px-6 py-3 bg-river-current hover:bg-river-current/80 text-cream font-medium rounded-lg transition-colors">
                NATO Expansion
              </Link>
...
function Section({
  ...
  const colorClasses = {
    ...
    green: "border-sovereign-gold/30 bg-sovereign-gold/10",
    yellow: "border-sovereign-gold/30 bg-sovereign-gold/10",
    cyan: "border-river-current/30 bg-river-current/10",
    emerald: "border-sovereign-gold/30 bg-sovereign-gold/10"
  }
...
function FundingFlowCard() {
  return (
    <div className="bg-cream/5 rounded-lg p-6 border border-cream/10">
      <h4 className="text-cream font-bold mb-4">Funding Flow: The Laundering Process</h4>
      <div className="space-y-3">
        <div className="flex items-center gap-3">
          <div className="w-6 h-6 bg-korean-red rounded-full flex items-center justify-center text-cream text-xs font-bold">1</div>
          <p className="text-cream/80 text-sm">Congressional appropriations to core organizations</p>
        </div>
        <div className="flex items-center gap-3">
          <div className="w-6 h-6 bg-sovereign-gold rounded-full flex items-center justify-center text-cream text-xs font-bold">2</div>
          <p className="text-cream/80 text-sm">Distribution to intermediary institutions and think tanks</p>
        </div>
        <div className="flex items-center gap-3">
          <div className="w-6 h-6 bg-sovereign-gold rounded-full flex items-center justify-center text-cream text-xs font-bold">3</div>
          <p className="text-cream/80 text-sm">Flow to academic centers and policy institutes</p>
        </div>
        <div className="flex items-center gap-3">
          <div className="w-6 h-6 bg-sovereign-gold rounded-full flex items-center justify-center text-cream text-xs font-bold">4</div>
          <p className="text-cream/80 text-sm">Final distribution to local NGOs and opposition groups</p>
        </div>
      </div>
      <div className="mt-4 p-3 bg-river-depths/20 rounded">
...
function CaseStudyCard({
  ...
  return (
    <div className="bg-cream/5 rounded-lg p-6 border border-cream/10">
      <h4 className="text-river-current font-bold mb-3">{title}</h4>
      <div className="grid md:grid-cols-2 gap-4">
        <div>
          <p className="text-river-current text-xs font-bold mb-1">Funding:</p>
          <p className="text-cream/80 text-sm mb-3">{funding}</p>
          <p className="text-river-current text-xs font-bold mb-1">Operations:</p>
...
function AcademicCard({
  ...
  return (
    <div className="bg-cream/5 rounded-lg p-4 border border-cream/10">
      <div className="flex items-start gap-4">
        <div className="w-12 h-12 bg-river-current/20 rounded-full flex items-center justify-center flex-shrink-0">
          <FileText className="w-6 h-6 text-river-current" />
        </div>
        <div className="flex-1">
          <h4 className="text-river-current font-bold mb-1">{scholar}</h4>
          <p className="text-river-current text-sm mb-2 italic">{work}</p>
          <p className="text-cream/80 text-sm mb-3">{finding}</p>
          <div className="p-3 bg-river-depths/20 rounded">
            <p className="text-sovereign-gold text-xs font-bold mb-1">Significance:</p>
            <p className="text-cream/70 text-xs">{significance}</p>
          </div>
        </div>
      </div>
    </div>
...
function YouthTargetingCard() {
  return (
    <div className="bg-korean-red/20 rounded-lg p-6 border border-korean-red/30">
      <h4 className="font-bold text-cream mb-3">Youth Mobilization Strategy</h4>
      <p className="text-cream/90 mb-4">
        Youth receive particular emphasis in regime change operations, with programs providing:
      </p>
      <div className="grid md:grid-cols-2 gap-4">
        <div>
          <h5 className="text-korean-red font-bold mb-2">Training Programs</h5>
          <ul className="text-cream/80 text-sm space-y-1">
        ...
        <div>
          <h5 className="text-sovereign-gold font-bold mb-2">Economic Incentives</h5>
          <ul className="text-cream/80 text-sm space-y-1">
      ...
      <div className="mt-4 p-3 bg-river-depths/20 rounded">
        <p className="text-korean-red text-xs font-bold">Effect:</p>
        <p className="text-cream/70 text-xs">
  ...
  return (
    <div className="bg-cream/5 rounded-lg p-4 border border-cream/10">
      <div className="flex items-center gap-3 mb-2">
        <h4 className="text-sovereign-gold font-bold">{country}</h4>
        <span className="text-cream/60 text-sm">({year})</span>
      </div>
      <p className="text-sovereign-gold text-sm font-medium mb-2">{law}</p>
      <p className="text-cream/80 text-xs">{requirement}</p>
    </div>
  )
}
  ...
  return (
    <div className="bg-cream/5 rounded-lg p-4 border border-cream/10">
      <div className="grid md:grid-cols-4 gap-3">
        <div>
          <h5 className="font-bold text-river-current mb-1">{operation}</h5>
          <p className="text-cream/60 text-xs">{year} • {agency}</p>
        </div>
        <div className="md:col-span-2">
          <p className="text-cream/80 text-sm">{description}</p>
        </div>
        <div>
          <p className="text-sovereign-gold text-xs font-medium mb-1">Status:</p>
          <p className="text-cream/70 text-xs">{status}</p>
        </div>
      </div>
    </div>
  )
