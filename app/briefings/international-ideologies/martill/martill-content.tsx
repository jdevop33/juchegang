  ...
  return (
    <section className="mx-auto w-full max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="rounded-lg border border-cream/20 bg-river-depths/40 p-4">
        ...
        <div className="rounded-lg border border-cream/20 bg-river-depths/40 p-4 md:col-span-2">
