...
export default function CracksSpreadEastContent() {
  return (
    <article className="container mx-auto px-4 py-16">
      <div className="max-w-4xl mx-auto prose prose-lg dark:prose-invert">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border border-[#d4a74a]/20">
              ...
              <tbody className="text-[#f0ebe3]/80">
                ...
                <tr>
                  <td className="p-3 font-mono text-xs">TCS 2876/89</td>
                  <td className="p-3">Jul 31, 1989</td>
                  <td className="p-3">Baltic Nationalists Press Ahead (Special Analysis)</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section className="mb-12">
          ...
          <p className="text-lg leading-relaxed mb-6">
            Yet what makes the document genuinely illuminating is who was <em>not</em> included in these discussions. <strong>Egon Krenz</strong>&mdash;the man who would eventually replace Honecker as General Secretary in October 1989&mdash;was not part of the reformist circle. The CIA noted this absence carefully. Krenz was a hardliner, a loyalist, a product of the party&rsquo;s ideological machinery. His exclusion from the Humboldt initiative signaled a fracture within the Politburo itself: reformers too weak to act openly, hardliners too ideologically blinkered to see what was coming.
          </p>
          <p className="text-lg leading-relaxed mb-6">
            The result was a regime defined by paralysis. The reformers could not reform because they lacked institutional power. The hardliners could not repress because Gorbachev&rsquo;s Moscow would not sanction a crackdown. And the population&mdash;watching Hungarian television, listening to West German radio, sensing the fear beneath the regime&rsquo;s bravado&mdash;was making its own calculations.
          </p>
          <p className="text-lg leading-relaxed mb-6">
            <strong>Four months after this brief was written, the Berlin Wall fell.</strong> The reformers never got their Humboldt proposals implemented. The hardliners never got their crackdown. The people simply walked through the wall while the state stood frozen, unable to shoot and unable to speak.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-lg leading-relaxed mb-6">
            If the East German document reveals paralysis at the center of a client state, the Baltic brief from July 28 reveals something even more dangerous to the Soviet project: <strong>the center itself was losing control of the periphery&rsquo;s economy</strong>.
          </p>
          <p className="text-lg leading-relaxed mb-6">
          ...
          <p className="text-lg leading-relaxed mb-6">
            The brief documents a revealing internal battle. <strong>Senior Soviet figures objected&mdash;and lost.</strong> Vitaly Vorotnikov, a member of the Politburo, and Yuri Maslyukov, chairman of Gosplan (the State Planning Committee), both argued against the accelerated timeline. Their objections were overruled. This was not a case of the center graciously devolving power. This was the center discovering it could no longer compel obedience even within its own governing institutions.
          </p>
          <p className="text-lg leading-relaxed mb-6">
            But the CIA&rsquo;s analysts were careful to note the ethnic dimension that made the Baltic situation more volatile and more complex than a simple center-periphery economic dispute. The <strong>Russian minority question</strong> was already emerging as a flashpoint. In Estonia, Russian workers had gone on strike&mdash;not against capitalism, not against exploitation, but against proposed electoral laws that they feared would marginalize them in a newly autonomous republic. The workers who had been brought to Estonia during decades of Soviet industrialization policy now faced the possibility that the political structures being built around them would not include them.
          </p>
          <p className="text-lg leading-relaxed mb-6">
            This observation would prove prescient. The Russian minority question in the Baltics did not disappear with independence in 1991. It persists to this day&mdash;a source of tension, a tool of Russian foreign policy, and a reminder that empire leaves demographic legacies that outlast every other form of imperial infrastructure.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-lg leading-relaxed mb-6">
            The third document, issued just three days after the economic autonomy brief, represents the CIA&rsquo;s most urgent assessment of the Baltic situation. Classified as a &ldquo;Special Analysis&rdquo;&mdash;a designation reserved for rapidly developing situations requiring senior policymaker attention&mdash;it describes a political landscape that had moved beyond reform and into the territory of systemic rupture.
          </p>
          <p className="text-lg leading-relaxed mb-6">
          ...
          <p className="text-lg leading-relaxed mb-6">
            The CIA observed that Baltic leaders were going further still, <strong>conducting their own foreign policy</strong>&mdash;establishing contacts with Western governments, engaging in diplomatic initiatives that bypassed the Soviet Foreign Ministry entirely. This was sovereignty in practice, if not yet in law.
          </p>
          <p className="text-lg leading-relaxed mb-6">
            Perhaps the most striking detail in the Special Analysis concerns the predicament of local Communist officials. The analysts noted that Communist Party members in the Baltic republics had been forced to <strong>&ldquo;out-nationalist the nationalists&rdquo;</strong> simply to maintain any political relevance. With party support polling at less than ten percent, Baltic Communists faced an existential choice: embrace the nationalist wave or be swept away by it. Most chose to ride the wave. The party apparatus, designed to suppress nationalist sentiment, had become its vehicle.
          </p>
          <p className="text-lg leading-relaxed mb-6">
            And then the document arrives at the question that defined everything: <strong>Would Gorbachev use force?</strong>
          </p>
          <p className="text-lg leading-relaxed mb-6">
            The CIA&rsquo;s assessment was that he had effectively ruled it out. Not through a public declaration&mdash;that would come later&mdash;but through a pattern of behavior, a series of private signals, and above all, through the logic of his own reform program. A leader who had staked his legitimacy on glasnost and perestroika, who had told the world that the Brezhnev Doctrine was dead, could not send tanks into Vilnius without destroying the very basis of his political authority.
          </p>
          <p className="text-lg leading-relaxed mb-6">
            The analysts understood what this meant. If force was off the table in the Baltics&mdash;the most assertive, the most organizationally advanced of the independence movements&mdash;then it was off the table everywhere. The empire&rsquo;s ultimate instrument of cohesion had been voluntarily surrendered by the empire&rsquo;s own leader.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-lg leading-relaxed mb-6">
            And at the center of everything, a leader who had decided&mdash;consciously or through the accumulated weight of his own reform logic&mdash;that force would not be used. Not in the Baltics. Not in East Germany. Not anywhere that the old empire was cracking.
          </p>
          <p className="text-lg leading-relaxed mb-6">
          ...
          <p className="text-lg leading-relaxed mb-8">
            The cracks had spread east. The wall had not yet fallen, but the intelligence community had already mapped the fault lines. What remained was for history to do what history does: move faster than anyone&mdash;even the analysts who saw it coming&mdash;expected.
          </p>
        </section>
