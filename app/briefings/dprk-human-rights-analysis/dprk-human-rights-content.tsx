    ...
    <article className="container mx-auto px-4 py-16">
      <div className="max-w-4xl mx-auto prose prose-lg dark:prose-invert">
          ...
          <div className="not-prose my-8">
            <div className="bg-river-depths/50 rounded-lg border border-river-current/30 overflow-hidden">
              <div className="bg-river-current/20 px-4 py-3 border-b border-river-current/30">
                <h3 className="text-lg font-bold text-cream">Core Treaty Ratification Comparison</h3>
              </div>
        ...
        <section className="mb-12">
          ...
          <div className="bg-river-current/10 border border-river-current/30 rounded-lg p-6 mb-6">
            <h4 className="text-lg font-bold text-cream mb-2">Homelessness Among the Accusers</h4>
        ...
        <section className="mb-12">
          ...
          <div className="not-prose my-8">
            <div className="bg-korean-red/10 border border-korean-red/30 rounded-lg p-6 text-center">
              ...
              <div className="text-cream/70 text-sm">US incarcerated population &mdash; the highest rate in the world</div>
              <div className="text-cream/50 text-xs mt-1">531&ndash;600 per 100,000 citizens. More prisoners than any nation on Earth.</div>
            </div>
          </div>
        ...
        <section className="mb-12">
          ...
          <blockquote className="border-l-4 border-sovereign-gold pl-6 my-8 italic text-sovereign-gold text-xl">
            ...
            <span className="block text-sm mt-2 text-cream/60 not-italic">&mdash; UN Special Rapporteur Alena Douhan</span>
          </blockquote>
          ...
          <div className="not-prose my-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-river-current/10 border border-river-current/30 rounded-lg p-6">
                <h4 className="text-lg font-bold text-cream mb-3">Ongoing Challenges (Context Matters)</h4>
                <ul className="space-y-3 text-cream/80 text-sm">
        ...
        <section className="mb-12">
          ...
          <div className="bg-river-current/10 border border-river-current/30 rounded-lg p-6 mb-6">
            <h4 className="text-lg font-bold text-cream mb-2">Third: Sanctions Are the Real Human Rights Crisis</h4>
            <p className="text-cream/90 leading-relaxed">
