    ...
    <article className="container mx-auto px-4 py-16">
      <div className="max-w-4xl mx-auto prose prose-lg dark:prose-invert">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-base text-cream-muted mt-4 max-w-2xl mx-auto">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold mb-6 text-cream">Source Documents at a Glance</h2>
        ...
        {/* Prologue */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold mb-6 text-cream">Prologue: Reading the Tea Leaves of Empire&rsquo;s End</h2>
        ...
        {/* Act I */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold mb-2 text-cream">Act I: The Gamble at the Roundtable</h2>
          <p className="text-sm text-cream-muted mb-6 font-mono">April 6, 1989 &mdash; TCS 2779/89</p>
          ...
          <div className="bg-sovereign-gold/5 border-l-4 border-sovereign-gold rounded-r-lg p-6 mb-8">
        ...
        {/* Act II */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold mb-2 text-cream">Act II: The Regime&rsquo;s Hail Mary</h2>
          <p className="text-sm text-cream-muted mb-6 font-mono">May 18, 1989 &mdash; TCS 2815/89</p>
        ...
        {/* Act III */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold mb-2 text-cream">Act III: The Election That Changed Everything</h2>
          <p className="text-sm text-cream-muted mb-6 font-mono">June 3, 1989 &mdash; TCS 2828/89 (Special Analysis)</p>
          ...
          <div className="bg-river-current/20 border border-river-current/30 rounded-lg p-6 mb-8">
            <h4 className="font-bold mb-3 text-river-current dark:text-[#4a9fd5]">CIA Warning &mdash; Proved Prophetic</h4>
        ...
        {/* Act IV */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold mb-2 text-cream">Act IV: The Collision</h2>
          <p className="text-sm text-cream-muted mb-6 font-mono">August 17, 1989 &mdash; TCS 2891/89</p>
        ...
        {/* Act V */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold mb-2 text-cream">Act V: The Capitulation</h2>
          <p className="text-sm text-cream-muted mb-6 font-mono">August 18, 1989 &mdash; TCS 2892/89</p>
          ...
          <div className="bg-river-current/20 border border-river-current/30 rounded-lg p-6 mb-8">
            <h4 className="font-bold mb-3 text-river-current dark:text-[#4a9fd5]">Regional Domino Effect</h4>
        ...
        {/* Lessons */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold mb-6 text-cream">Lessons for the Modern Security Professional</h2>
          ...
          <div className="bg-sovereign-gold/5 border-l-4 border-sovereign-gold rounded-r-lg p-6 mb-8">
            <h3 className="text-xl font-bold mb-3 text-sovereign-gold">1. Controlled transitions rarely stay controlled</h3>
          ...
          <div className="bg-sovereign-gold/5 border-l-4 border-sovereign-gold rounded-r-lg p-6 mb-8">
            <h3 className="text-xl font-bold mb-3 text-sovereign-gold">2. The gap between intelligence and foresight</h3>
            <p className="text-lg leading-relaxed">
          ...
          <div className="bg-sovereign-gold/5 border-l-4 border-sovereign-gold rounded-r-lg p-6 mb-8">
            <h3 className="text-xl font-bold mb-3 text-sovereign-gold">3. The decisive role of individual judgment under pressure</h3>
            <p className="text-lg leading-relaxed">
          ...
          <div className="bg-sovereign-gold/5 border-l-4 border-sovereign-gold rounded-r-lg p-6 mb-8">
            <h3 className="text-xl font-bold mb-3 text-sovereign-gold">4. The morning after the revolution</h3>
            <p className="text-lg leading-relaxed">
        ...
        {/* Epilogue */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold mb-6 text-cream">Epilogue: What the Stamps Tell Us</h2>
        ...
        {/* Source Note */}
        <section className="mb-12">
          <div className="bg-river-depths/50 border border-river-current/30 rounded-lg p-6">
            <h4 className="font-bold mb-3 text-sovereign-gold text-sm tracking-widest uppercase">About This Analysis</h4>
        ...
        {/* Series Navigation */}
        <section className="mb-12">
          <div className="bg-sovereign-gold/5 border border-sovereign-gold/30 rounded-lg p-6 text-center">
            <p className="text-sm tracking-widest uppercase text-sovereign-gold mb-3">Classified to Declassified Series</p>
            <p className="text-lg mb-4 text-cream">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-sovereign-gold text-river-depths rounded-lg font-semibold hover:bg-sovereign-gold/90 transition-colors no-underline"
            >
