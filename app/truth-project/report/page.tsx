  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <header className="mb-10">
        <h1 className="text-4xl md:text-6xl font-bold text-[#f0ebe3] mb-4">Comprehensive Image Report</h1>
        <p className="text-xl text-[#f0ebe3]/80">Interactive visual review, inferred meaning, and narrative framing.</p>
      </header>
      ...
      <div className="grid lg:grid-cols-3 gap-8 items-start">
        <div className="lg:col-span-2 space-y-8">
          ...
          <section aria-labelledby="visual-analysis" className="space-y-4 bg-[#f0ebe3]/5 border border-[#f0ebe3]/10 rounded-xl p-6">
            <h2 id="visual-analysis" className="text-2xl font-bold text-[#f0ebe3] flex items-center gap-2"><ImageIcon className="h-5 w-5" /> Visual content analysis</h2>
            <ul className="list-disc pl-6 text-[#f0ebe3]/80 space-y-2">
          ...
          <section aria-labelledby="inferred-meaning" className="space-y-4 bg-[#f0ebe3]/5 border border-[#f0ebe3]/10 rounded-xl p-6">
            <h2 id="inferred-meaning" className="text-2xl font-bold text-[#f0ebe3] flex items-center gap-2"><Newspaper className="h-5 w-5" /> Inferred meaning</h2>
          ...
          <section aria-labelledby="narrative-arc" className="space-y-4 bg-[#f0ebe3]/5 border border-[#f0ebe3]/10 rounded-xl p-6">
            <h2 id="narrative-arc" className="text-2xl font-bold text-[#f0ebe3] flex items-center gap-2"><FileText className="h-5 w-5" /> Narrative arc for the page</h2>
            <ol className="list-decimal pl-6 text-[#f0ebe3]/80 space-y-2">
        ...
        <aside className="space-y-6">
          <div className="bg-[#1b4965]/20 border border-[#1b4965]/30 rounded-xl p-5">
            ...
            <p className="text-[#f0ebe3]/80 mb-3">Read the long-form reflection that pairs with this report.</p>
            <Link href="/truth-project/op-ed" className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[#1b4965] text-[#f0ebe3] hover:bg-[#1b4965]/80">
          ...
          <div className="bg-[#d4a74a]/20 border border-[#d4a74a]/30 rounded-xl p-5">
            ...
            <p className="text-[#f0ebe3]/80 mb-3">Want to join the Truth Project? Reach out.</p>
