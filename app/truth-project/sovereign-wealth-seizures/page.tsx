  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <header className="mb-12">
        <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 bg-sovereign-gold/10 text-sovereign-gold rounded-full text-sm font-medium">
          <DollarSign className="h-4 w-4" />
          Historical Analysis
        </div>
        <h1 className="text-4xl md:text-6xl font-bold text-cream mb-6">Sovereign Wealth Seizures Through History</h1>
      ...
      <div className="grid lg:grid-cols-4 gap-8">
        <article className="lg:col-span-3 space-y-8">
          ...
          <section className="bg-sovereign-gold/20 border border-sovereign-gold/30 rounded-xl p-6">
            <h2 className="text-2xl font-bold text-sovereign-gold mb-4 flex items-center gap-2">
              <TrendingUp className="h-5 w-5" />
              Unprecedented Scale of Current Seizures
            </h2>
            <div className="grid md:grid-cols-3 gap-6">
              <div>
                <h3 className="text-lg font-bold text-cream mb-3">Russian Assets</h3>
              ...
              <div>
                <h3 className="text-lg font-bold text-cream mb-3">Other Cases</h3>
                <ul className="space-y-2 text-cream/90 text-sm">
              ...
              <div>
                <h3 className="text-lg font-bold text-cream mb-3">Global Impact</h3>
                <ul className="space-y-2 text-cream/90 text-sm">
          ...
          <section className="space-y-6">
            <h2 className="text-3xl font-bold text-cream flex items-center gap-3">
            ...
            <div className="prose prose-lg prose-invert max-w-none">
              ...
              <div className="bg-korean-red/20 border border-korean-red/30 rounded-xl p-6 my-8">
                <h3 className="text-xl font-bold text-korean-red mb-3">World War I Precedent</h3>
          ...
          {/* Cold War Era */}
          <section className="space-y-6">
            <h2 className="text-3xl font-bold text-cream">Cold War innovations in economic warfare</h2>
            <div className="prose prose-lg prose-invert max-w-none">
              <p className="text-cream/90 leading-relaxed">
              ...
              <div className="bg-river-current/20 border border-river-current/30 rounded-xl p-6 my-8">
                <h3 className="text-xl font-bold text-river-current mb-3">The Suez Crisis Turning Point</h3>
                <p className="text-cream/80">
          ...
          {/* Iraq Precedent */}
          <section className="space-y-6">
            <h2 className="text-3xl font-bold text-cream">The Iraq precedent and its modern implications</h2>
            <div className="prose prose-lg prose-invert max-w-none">
              <p className="text-cream/90 leading-relaxed">
              ...
              <div className="bg-sovereign-gold/20 border border-sovereign-gold/30 rounded-xl p-6 my-8">
                <h3 className="text-xl font-bold text-sovereign-gold mb-3">UN Authorization vs. Current Cases</h3>
                <p className="text-cream/80">
          ...
          <section className="space-y-6">
            ...
            <div className="prose prose-lg prose-invert max-w-none">
              ...
              <div className="grid md:grid-cols-2 gap-6 my-8">
                <div className="bg-sovereign-gold/20 border border-sovereign-gold/30 rounded-xl p-6">
                  <h3 className="text-lg font-bold text-sovereign-gold mb-3">Islamic Legal Traditions</h3>
                ...
                <div className="bg-sovereign-gold/20 border border-sovereign-gold/30 rounded-xl p-6">
                  <h3 className="text-lg font-bold text-sovereign-gold mb-3">Global South Views</h3>
                  <ul className="space-y-2 text-cream/80 text-sm">
          ...
          <section className="space-y-6">
            ...
            <div className="prose prose-lg prose-invert max-w-none">
              ...
              <div className="bg-korean-red/20 border border-korean-red/30 rounded-xl p-6 my-8">
                <h3 className="text-xl font-bold text-korean-red mb-3">Legal Constraints</h3>
                <p className="text-cream/80">
          ...
          {/* Legitimacy Spectrum */}
          <section className="space-y-6">
            <h2 className="text-3xl font-bold text-cream">The legitimacy spectrum</h2>
            <div className="prose prose-lg prose-invert max-w-none">
              <p className="text-cream/90 leading-relaxed">
              ...
              <div className="bg-sovereign-gold/20 border border-sovereign-gold/30 rounded-xl p-6 my-8">
                <h3 className="text-xl font-bold text-sovereign-gold mb-3">Most Legitimate Precedents</h3>
          ...
          <section className="space-y-6">
            ...
            <div className="prose prose-lg prose-invert max-w-none">
              ...
              <div className="bg-korean-red/20 border border-korean-red/30 rounded-xl p-6 my-8">
                <h3 className="text-xl font-bold text-korean-red mb-3">Precedent Risks</h3>
                <ul className="space-y-2 text-cream/80">
          ...
          {/* Conclusion */}
          <section className="space-y-6 bg-river-depths/50 border border-river-depths/50 rounded-xl p-8">
            <h2 className="text-3xl font-bold text-cream">Conclusion</h2>
            <div className="prose prose-lg prose-invert max-w-none">
              <p className="text-cream/90 leading-relaxed">
        ...
        <aside className="space-y-6">
          <div className="bg-sovereign-gold/20 border border-sovereign-gold/30 rounded-xl p-5">
            <h3 className="text-lg font-semibold text-sovereign-gold mb-2">Historical Scale</h3>
          ...
          <div className="bg-river-current/20 border border-river-current/30 rounded-xl p-5">
            <h3 className="text-lg font-semibold text-river-current mb-2">Legal Frameworks</h3>
            <ul className="text-sm text-cream/80 space-y-2">
          ...
          <div className="bg-korean-red/20 border border-korean-red/30 rounded-xl p-5">
            <h3 className="text-lg font-semibold text-korean-red mb-2">Cultural Perspectives</h3>
            <ul className="text-sm text-cream/80 space-y-2">
          ...
          <div className="bg-sovereign-gold/20 border border-sovereign-gold/30 rounded-xl p-5">
            <h3 className="text-lg font-semibold text-sovereign-gold mb-2">Related Reports</h3>
            <div className="space-y-3">
              <Link href="/truth-project/wikipedia-neutrality" className="block text-sm text-cream/80 hover:text-cream underline">
                Wikipedia's Contested Neutrality
              </Link>
              <Link href="/truth-project/fiction-becomes-fact" className="block text-sm text-cream/80 hover:text-cream underline">
          ...
          <div className="bg-sovereign-gold/20 border border-sovereign-gold/30 rounded-xl p-5">
            <h3 className="text-lg font-semibold text-sovereign-gold mb-2">Truth Project</h3>
            <p className="text-cream/80 mb-3 text-sm">Analyzing power structures in international relations and financial systems.</p>
            <Link href="/truth-project" className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-sovereign-gold text-river-depths hover:bg-sovereign-gold/80 text-sm">
