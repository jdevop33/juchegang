  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <header className="mb-12">
        ...
        <h1 className="text-4xl md:text-6xl font-bold text-[#e8e4df] mb-6">Sovereign Wealth Seizures Through History</h1>
        ...
        <article className="lg:col-span-3 space-y-8">
          ...
          <section className="bg-[#d4a74a]/20 border border-[#d4a74a]/30 rounded-xl p-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div>
                <h3 className="text-lg font-bold text-[#e8e4df] mb-3">Russian Assets</h3>
                <ul className="space-y-2 text-[#e8e4df]/90 text-sm">
              ...
              <div>
                <h3 className="text-lg font-bold text-[#e8e4df] mb-3">Other Cases</h3>
                <ul className="space-y-2 text-[#e8e4df]/90 text-sm">
              ...
              <div>
                <h3 className="text-lg font-bold text-[#e8e4df] mb-3">Global Impact</h3>
                <ul className="space-y-2 text-[#e8e4df]/90 text-sm">
          ...
          {/* Cold War Era */}
          <section className="space-y-6">
            <h2 className="text-3xl font-bold text-[#e8e4df]">Cold War innovations in economic warfare</h2>
            <div className="prose prose-lg prose-invert max-w-none">
              <p className="text-[#e8e4df]/90 leading-relaxed">
          ...
          {/* Iraq Precedent */}
          <section className="space-y-6">
            <h2 className="text-3xl font-bold text-[#e8e4df]">The Iraq precedent and its modern implications</h2>
            <div className="prose prose-lg prose-invert max-w-none">
              <p className="text-[#e8e4df]/90 leading-relaxed">
          ...
          {/* Legitimacy Spectrum */}
          <section className="space-y-6">
            <h2 className="text-3xl font-bold text-[#e8e4df]">The legitimacy spectrum</h2>
            <div className="prose prose-lg prose-invert max-w-none">
              <p className="text-[#e8e4df]/90 leading-relaxed">
          ...
          <section className="space-y-6 bg-[#0d1b2a]/50 border border-[#0d1b2a]/50 rounded-xl p-8">
            <h2 className="text-3xl font-bold text-[#e8e4df]">Conclusion</h2>
            <div className="prose prose-lg prose-invert max-w-none">
              <p className="text-[#e8e4df]/90 leading-relaxed">
        ...
        <aside className="space-y-6">
          ...
          <div className="bg-[#d4a74a]/20 border border-[#d4a74a]/30 rounded-xl p-5">
            ...
            <div className="space-y-3">
              <Link href="/truth-project/wikipedia-neutrality" className="block text-sm text-[#e8e4df]/80 hover:text-[#e8e4df] underline">
                Wikipedia's Contested Neutrality
              </Link>
              <Link href="/truth-project/fiction-becomes-fact" className="block text-sm text-[#e8e4df]/80 hover:text-[#e8e4df] underline">
          ...
          <div className="bg-[#d4a74a]/20 border border-[#d4a74a]/30 rounded-xl p-5">
            ...
            <p className="text-[#e8e4df]/80 mb-3 text-sm">Analyzing power structures in international relations and financial systems.</p>
