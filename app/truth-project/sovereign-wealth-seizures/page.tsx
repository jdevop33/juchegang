  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <header className="mb-12">
        <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 bg-[#d4a74a]/10 text-[#d4a74a] rounded-full text-sm font-medium">
          <DollarSign className="h-4 w-4" />
          Historical Analysis
        </div>
        <h1 className="text-4xl md:text-6xl font-bold text-[#f0ebe3] mb-6">Sovereign Wealth Seizures Through History</h1>
      ...
      <div className="grid lg:grid-cols-4 gap-8">
        <article className="lg:col-span-3 space-y-8">
          ...
          <section className="bg-[#d4a74a]/20 border border-[#d4a74a]/30 rounded-xl p-6">
            <h2 className="text-2xl font-bold text-[#d4a74a] mb-4 flex items-center gap-2">
              <TrendingUp className="h-5 w-5" />
              Unprecedented Scale of Current Seizures
            </h2>
            <div className="grid md:grid-cols-3 gap-6">
              <div>
                <h3 className="text-lg font-bold text-[#f0ebe3] mb-3">Russian Assets</h3>
                <ul className="space-y-2 text-[#f0ebe3]/90 text-sm">
              ...
              <div>
                <h3 className="text-lg font-bold text-[#f0ebe3] mb-3">Other Cases</h3>
                <ul className="space-y-2 text-[#f0ebe3]/90 text-sm">
              ...
              <div>
                <h3 className="text-lg font-bold text-[#f0ebe3] mb-3">Global Impact</h3>
                <ul className="space-y-2 text-[#f0ebe3]/90 text-sm">
          ...
          <section className="space-y-6">
            ...
            <div className="prose prose-lg prose-invert max-w-none">
              ...
              <div className="bg-[#c73032]/20 border border-[#c73032]/30 rounded-xl p-6 my-8">
                <h3 className="text-xl font-bold text-[#c73032] mb-3">World War I Precedent</h3>
          ...
          {/* Cold War Era */}
          <section className="space-y-6">
            <h2 className="text-3xl font-bold text-[#f0ebe3]">Cold War innovations in economic warfare</h2>
            <div className="prose prose-lg prose-invert max-w-none">
              <p className="text-[#f0ebe3]/90 leading-relaxed">
              ...
              <div className="bg-[#1b4965]/20 border border-[#1b4965]/30 rounded-xl p-6 my-8">
                <h3 className="text-xl font-bold text-[#1b4965] mb-3">The Suez Crisis Turning Point</h3>
                <p className="text-[#f0ebe3]/80">
          ...
          {/* Iraq Precedent */}
          <section className="space-y-6">
            <h2 className="text-3xl font-bold text-[#f0ebe3]">The Iraq precedent and its modern implications</h2>
            <div className="prose prose-lg prose-invert max-w-none">
              <p className="text-[#f0ebe3]/90 leading-relaxed">
              ...
              <div className="bg-[#d4a74a]/20 border border-[#d4a74a]/30 rounded-xl p-6 my-8">
                <h3 className="text-xl font-bold text-[#d4a74a] mb-3">UN Authorization vs. Current Cases</h3>
                <p className="text-[#f0ebe3]/80">
          ...
          <section className="space-y-6">
            ...
            <div className="prose prose-lg prose-invert max-w-none">
              ...
              <div className="grid md:grid-cols-2 gap-6 my-8">
                <div className="bg-[#d4a74a]/20 border border-[#d4a74a]/30 rounded-xl p-6">
                  <h3 className="text-lg font-bold text-[#d4a74a] mb-3">Islamic Legal Traditions</h3>
                ...
                <div className="bg-[#d4a74a]/20 border border-[#d4a74a]/30 rounded-xl p-6">
                  <h3 className="text-lg font-bold text-[#d4a74a] mb-3">Global South Views</h3>
                  <ul className="space-y-2 text-[#f0ebe3]/80 text-sm">
          ...
          <section className="space-y-6">
            ...
            <div className="prose prose-lg prose-invert max-w-none">
              ...
              <div className="bg-[#c73032]/20 border border-[#c73032]/30 rounded-xl p-6 my-8">
                <h3 className="text-xl font-bold text-[#c73032] mb-3">Legal Constraints</h3>
                <p className="text-[#f0ebe3]/80">
          ...
          {/* Legitimacy Spectrum */}
          <section className="space-y-6">
            <h2 className="text-3xl font-bold text-[#f0ebe3]">The legitimacy spectrum</h2>
            <div className="prose prose-lg prose-invert max-w-none">
              <p className="text-[#f0ebe3]/90 leading-relaxed">
              ...
              <div className="bg-[#d4a74a]/20 border border-[#d4a74a]/30 rounded-xl p-6 my-8">
                <h3 className="text-xl font-bold text-[#d4a74a] mb-3">Most Legitimate Precedents</h3>
          ...
          <section className="space-y-6">
            ...
            <div className="prose prose-lg prose-invert max-w-none">
              ...
              <div className="bg-[#c73032]/20 border border-[#c73032]/30 rounded-xl p-6 my-8">
                <h3 className="text-xl font-bold text-[#c73032] mb-3">Precedent Risks</h3>
                <ul className="space-y-2 text-[#f0ebe3]/80">
          ...
          {/* Conclusion */}
          <section className="space-y-6 bg-[#0d1b2a]/50 border border-[#0d1b2a]/50 rounded-xl p-8">
            <h2 className="text-3xl font-bold text-[#f0ebe3]">Conclusion</h2>
            <div className="prose prose-lg prose-invert max-w-none">
              <p className="text-[#f0ebe3]/90 leading-relaxed">
        ...
        <aside className="space-y-6">
          <div className="bg-[#d4a74a]/20 border border-[#d4a74a]/30 rounded-xl p-5">
            <h3 className="text-lg font-semibold text-[#d4a74a] mb-2">Historical Scale</h3>
          ...
          <div className="bg-[#1b4965]/20 border border-[#1b4965]/30 rounded-xl p-5">
            <h3 className="text-lg font-semibold text-[#1b4965] mb-2">Legal Frameworks</h3>
            <ul className="text-sm text-[#f0ebe3]/80 space-y-2">
          ...
          <div className="bg-[#c73032]/20 border border-[#c73032]/30 rounded-xl p-5">
            <h3 className="text-lg font-semibold text-[#c73032] mb-2">Cultural Perspectives</h3>
            <ul className="text-sm text-[#f0ebe3]/80 space-y-2">
          ...
          <div className="bg-[#d4a74a]/20 border border-[#d4a74a]/30 rounded-xl p-5">
            <h3 className="text-lg font-semibold text-[#d4a74a] mb-2">Related Reports</h3>
            <div className="space-y-3">
              <Link href="/truth-project/wikipedia-neutrality" className="block text-sm text-[#f0ebe3]/80 hover:text-[#f0ebe3] underline">
                Wikipedia's Contested Neutrality
              </Link>
              <Link href="/truth-project/fiction-becomes-fact" className="block text-sm text-[#f0ebe3]/80 hover:text-[#f0ebe3] underline">
          ...
          <div className="bg-[#d4a74a]/20 border border-[#d4a74a]/30 rounded-xl p-5">
            ...
            <p className="text-[#f0ebe3]/80 mb-3 text-sm">Analyzing power structures in international relations and financial systems.</p>
            <Link href="/truth-project" className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[#d4a74a] text-[#0d1b2a] hover:bg-[#d4a74a]/80 text-sm">
