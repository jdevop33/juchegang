  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <header className="mb-12">
        <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 bg-[#c73032]/20 text-[#c73032] rounded-full text-sm font-medium">
          <Shield className="h-4 w-4" />
          Comprehensive Investigation
        </div>
        <h1 className="text-4xl md:text-6xl font-bold text-[#f0ebe3] mb-6">Wikipedia's Contested Neutrality</h1>
      ...
      <div className="grid lg:grid-cols-4 gap-8">
        <article className="lg:col-span-3 space-y-8">
          {/* Executive Summary */}
          <section className="bg-[#c73032]/20 border border-[#c73032]/40 rounded-xl p-6">
            <h2 className="text-2xl font-bold text-[#c73032] mb-4 flex items-center gap-2">
              <AlertTriangle className="h-5 w-5" />
              Critical Findings
            </h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="text-lg font-bold text-[#f0ebe3] mb-3">Power Concentration</h3>
              ...
              <div>
                <h3 className="text-lg font-bold text-[#f0ebe3] mb-3">Financial Dependencies</h3>
                <ul className="space-y-2 text-[#f0ebe3]/90 text-sm">
          ...
          <section className="space-y-6">
            ...
            <div className="prose prose-lg prose-invert max-w-none">
              ...
              <div className="bg-[#1b4965]/20 border border-[#1b4965]/40 rounded-xl p-6 my-8">
                <h3 className="text-xl font-bold text-[#1b4965] mb-3">Financial Structure</h3>
          ...
          {/* Academic Research */}
          <section className="space-y-6">
            <h2 className="text-3xl font-bold text-[#f0ebe3]">Academic research confirms accuracy alongside systematic bias</h2>
            <div className="prose prose-lg prose-invert max-w-none">
              <p className="text-[#f0ebe3]/90 leading-relaxed">
              ...
              <div className="grid md:grid-cols-2 gap-6 my-8">
                <div className="bg-[#c73032]/20 border border-[#c73032]/40 rounded-xl p-6">
                  <h3 className="text-lg font-bold text-[#c73032] mb-3">Gender Bias</h3>
                ...
                <div className="bg-[#d4a74a]/20 border border-[#d4a74a]/40 rounded-xl p-6">
                  <h3 className="text-lg font-bold text-[#d4a74a] mb-3">Geographic Bias</h3>
                  <ul className="space-y-2 text-[#f0ebe3]/80 text-sm">
          ...
          <section className="space-y-6">
            ...
            <div className="prose prose-lg prose-invert max-w-none">
              ...
              <div className="bg-[#c73032]/20 border border-[#c73032]/40 rounded-xl p-6 my-8">
                <h3 className="text-xl font-bold text-[#c73032] mb-3">China's Strategic Infiltration</h3>
                <p className="text-[#f0ebe3]/80">
          ...
          {/* Alternative Sources */}
          <section className="space-y-6">
            <h2 className="text-3xl font-bold text-[#f0ebe3]">Alternative knowledge sources reveal universal bias problems</h2>
            <div className="prose prose-lg prose-invert max-w-none">
              <p className="text-[#f0ebe3]/90 leading-relaxed">
              ...
              <div className="bg-[#1b4965]/20 border border-[#1b4965]/40 rounded-xl p-6 my-8">
                <h3 className="text-xl font-bold text-[#1b4965] mb-3">Platform Limitations</h3>
                <p className="text-[#f0ebe3]/80">
          ...
          <section className="space-y-6">
            ...
            <div className="prose prose-lg prose-invert max-w-none">
              ...
              <div className="bg-[#c73032]/20 border border-[#c73032]/40 rounded-xl p-6 my-8">
                <h3 className="text-xl font-bold text-[#c73032] mb-3">Current Conflict Zones</h3>
          ...
          <section className="space-y-6 bg-[#0d1b2a]/50 border border-[#1b4965]/40 rounded-xl p-8">
            <h2 className="text-3xl font-bold text-[#f0ebe3]">Conclusion: The paradox of democratized knowledge under systematic capture</h2>
            <div className="prose prose-lg prose-invert max-w-none">
              <p className="text-[#f0ebe3]/90 leading-relaxed">
        ...
        <aside className="space-y-6">
          <div className="bg-[#c73032]/20 border border-[#c73032]/40 rounded-xl p-5">
            <h3 className="text-lg font-semibold text-[#c73032] mb-2">Investigation Scope</h3>
          ...
          <div className="bg-[#1b4965]/20 border border-[#1b4965]/40 rounded-xl p-5">
            <h3 className="text-lg font-semibold text-[#1b4965] mb-2">Key Statistics</h3>
            <ul className="text-sm text-[#f0ebe3]/80 space-y-2">
          ...
          <div className="bg-[#d4a74a]/20 border border-[#d4a74a]/40 rounded-xl p-5">
            <h3 className="text-lg font-semibold text-[#d4a74a] mb-2">Related Reports</h3>
            <div className="space-y-3">
              <Link href="/truth-project/wikipedia-bureaucrats" className="block text-sm text-[#f0ebe3]/80 hover:text-[#f0ebe3] underline">
          ...
          <div className="bg-[#1b4965]/20 border border-[#1b4965]/40 rounded-xl p-5">
            ...
            <p className="text-[#f0ebe3]/80 mb-3 text-sm">Investigating hidden power structures and systematic bias in information systems.</p>
