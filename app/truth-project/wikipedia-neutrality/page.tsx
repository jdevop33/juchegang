  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <header className="mb-12">
        ...
        <h1 className="text-4xl md:text-6xl font-bold text-cream mb-6">Wikipedia's Contested Neutrality</h1>
      ...
      <div className="grid lg:grid-cols-4 gap-8">
        <article className="lg:col-span-3 space-y-8">
          ...
          <section className="bg-korean-red/20 border border-korean-red/40 rounded-xl p-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="text-lg font-bold text-cream mb-3">Power Concentration</h3>
              ...
              <div>
                <h3 className="text-lg font-bold text-cream mb-3">Financial Dependencies</h3>
                <ul className="space-y-2 text-cream/90 text-sm">
          ...
          <section className="space-y-6">
            ...
            <div className="prose prose-lg prose-invert max-w-none">
              ...
              <div className="bg-river-current/20 border border-river-current/40 rounded-xl p-6 my-8">
                <h3 className="text-xl font-bold text-river-current mb-3">Financial Structure</h3>
          ...
          {/* Academic Research */}
          <section className="space-y-6">
            <h2 className="text-3xl font-bold text-cream">Academic research confirms accuracy alongside systematic bias</h2>
            <div className="prose prose-lg prose-invert max-w-none">
              <p className="text-cream/90 leading-relaxed">
              ...
              <div className="grid md:grid-cols-2 gap-6 my-8">
                <div className="bg-korean-red/20 border border-korean-red/40 rounded-xl p-6">
                  <h3 className="text-lg font-bold text-korean-red mb-3">Gender Bias</h3>
                ...
                <div className="bg-sovereign-gold/20 border border-sovereign-gold/40 rounded-xl p-6">
                  <h3 className="text-lg font-bold text-sovereign-gold mb-3">Geographic Bias</h3>
                  <ul className="space-y-2 text-cream/80 text-sm">
          ...
          <section className="space-y-6">
            ...
            <div className="prose prose-lg prose-invert max-w-none">
              ...
              <div className="bg-korean-red/20 border border-korean-red/40 rounded-xl p-6 my-8">
                <h3 className="text-xl font-bold text-korean-red mb-3">China's Strategic Infiltration</h3>
                <p className="text-cream/80">
          ...
          {/* Alternative Sources */}
          <section className="space-y-6">
            <h2 className="text-3xl font-bold text-cream">Alternative knowledge sources reveal universal bias problems</h2>
            <div className="prose prose-lg prose-invert max-w-none">
              <p className="text-cream/90 leading-relaxed">
              ...
              <div className="bg-river-current/20 border border-river-current/40 rounded-xl p-6 my-8">
                <h3 className="text-xl font-bold text-river-current mb-3">Platform Limitations</h3>
                <p className="text-cream/80">
          ...
          <section className="space-y-6">
            ...
            <div className="prose prose-lg prose-invert max-w-none">
              ...
              <div className="bg-korean-red/20 border border-korean-red/40 rounded-xl p-6 my-8">
                <h3 className="text-xl font-bold text-korean-red mb-3">Current Conflict Zones</h3>
          ...
          <section className="space-y-6 bg-river-depths/50 border border-river-current/40 rounded-xl p-8">
            <h2 className="text-3xl font-bold text-cream">Conclusion: The paradox of democratized knowledge under systematic capture</h2>
            <div className="prose prose-lg prose-invert max-w-none">
              <p className="text-cream/90 leading-relaxed">
        ...
        <aside className="space-y-6">
          <div className="bg-korean-red/20 border border-korean-red/40 rounded-xl p-5">
            <h3 className="text-lg font-semibold text-korean-red mb-2">Investigation Scope</h3>
          ...
          <div className="bg-river-current/20 border border-river-current/40 rounded-xl p-5">
            <h3 className="text-lg font-semibold text-river-current mb-2">Key Statistics</h3>
            <ul className="text-sm text-cream/80 space-y-2">
          ...
          <div className="bg-sovereign-gold/20 border border-sovereign-gold/40 rounded-xl p-5">
            <h3 className="text-lg font-semibold text-sovereign-gold mb-2">Related Reports</h3>
            <div className="space-y-3">
              <Link href="/truth-project/wikipedia-bureaucrats" className="block text-sm text-cream/80 hover:text-cream underline">
          ...
          <div className="bg-river-current/20 border border-river-current/40 rounded-xl p-5">
            ...
            <p className="text-cream/80 mb-3 text-sm">Investigating hidden power structures and systematic bias in information systems.</p>
