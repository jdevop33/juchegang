  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <header className="mb-12">
        ...
        <h1 className="text-4xl md:text-6xl font-bold text-[#e8e4df] mb-6">Wikipedia's Contested Neutrality</h1>
        ...
        <article className="lg:col-span-3 space-y-8">
          ...
          <section className="bg-[#c73032]/20 border border-[#c73032]/40 rounded-xl p-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="text-lg font-bold text-[#e8e4df] mb-3">Power Concentration</h3>
              ...
              <div>
                <h3 className="text-lg font-bold text-[#e8e4df] mb-3">Financial Dependencies</h3>
                <ul className="space-y-2 text-[#e8e4df]/90 text-sm">
          ...
          {/* Academic Research */}
          <section className="space-y-6">
            <h2 className="text-3xl font-bold text-[#e8e4df]">Academic research confirms accuracy alongside systematic bias</h2>
            <div className="prose prose-lg prose-invert max-w-none">
              <p className="text-[#e8e4df]/90 leading-relaxed">
          ...
          {/* Alternative Sources */}
          <section className="space-y-6">
            <h2 className="text-3xl font-bold text-[#e8e4df]">Alternative knowledge sources reveal universal bias problems</h2>
            <div className="prose prose-lg prose-invert max-w-none">
              <p className="text-[#e8e4df]/90 leading-relaxed">
          ...
          <section className="space-y-6 bg-[#0d1b2a]/50 border border-[#1b4965]/40 rounded-xl p-8">
            <h2 className="text-3xl font-bold text-[#e8e4df]">Conclusion: The paradox of democratized knowledge under systematic capture</h2>
            <div className="prose prose-lg prose-invert max-w-none">
              <p className="text-[#e8e4df]/90 leading-relaxed">
        ...
        <aside className="space-y-6">
          ...
          <div className="bg-[#d4a74a]/20 border border-[#d4a74a]/40 rounded-xl p-5">
            ...
            <div className="space-y-3">
              <Link href="/truth-project/wikipedia-bureaucrats" className="block text-sm text-[#e8e4df]/80 hover:text-[#e8e4df] underline">
          ...
          <div className="bg-[#1b4965]/20 border border-[#1b4965]/40 rounded-xl p-5">
            ...
            <p className="text-[#e8e4df]/80 mb-3 text-sm">Investigating hidden power structures and systematic bias in information systems.</p>
