      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-12 bg-[#1b4965]/30 rounded-2xl p-8 border border-[#c73032]/20">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-[#e8e4df] mb-4">We Are Not What We Say We Are</h2>
            <p className="text-xl text-[#d4a74a] mb-4">We Are Only What We Do</p>
            <p className="text-[#e8e4df]/80 max-w-3xl mx-auto">
            ...
            <div className="bg-[#0d1b2a]/50 rounded-lg p-6">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="bg-[#c73032]/10 rounded-lg p-6 border border-[#c73032]/30">
                  <h4 className="font-bold text-[#e8e4df] mb-3">What They Say</h4>
                ...
                <div className="bg-[#0d1b2a]/50 rounded-lg p-6 border border-[#1b4965]">
                  <h4 className="font-bold text-[#e8e4df] mb-3">What They Do</h4>
                  <ul className="space-y-2 text-[#e8e4df]/80 text-sm">
              ...
              <div className="bg-[#1b4965]/20 rounded-lg p-6 border border-[#c73032]/20">
                ...
                <div className="mt-4 p-4 bg-[#0d1b2a]/50 rounded">
                  ...
                  <p className="text-[#e8e4df]/60 text-sm mt-2">- Dwight D. Eisenhower, 1953</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#0d1b2a]/50 rounded-lg p-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-[#d4a74a]/10 rounded-lg p-4 border border-[#d4a74a]/30">
                  <h4 className="font-bold text-[#e8e4df] mb-3">Western "Aid" Model</h4>
                  <ul className="space-y-2 text-[#e8e4df]/80 text-sm">
                ...
                <div className="bg-[#1b4965]/20 rounded-lg p-4 border border-[#1b4965]">
                  <h4 className="font-bold text-[#e8e4df] mb-3">Chinese Infrastructure Model</h4>
                  <ul className="space-y-2 text-[#e8e4df]/80 text-sm">
              ...
              <div className="mt-6 p-6 bg-[#1b4965]/20 rounded-lg border border-[#d4a74a]/20">
                <blockquote className="text-[#e8e4df]/90 italic text-lg">
                  "China is not like the West, which interferes in Ethiopian domestic affairs when they provide aid."
                </blockquote>
                <p className="text-sm text-[#e8e4df]/60 mt-2">- Ethiopian Government Officials</p>
          ...
          <div className="space-y-6">
            <div className="bg-[#0d1b2a]/50 rounded-lg p-6">
              ...
              <div className="bg-[#c73032]/10 rounded-lg p-6 border border-[#c73032]/30 mb-6">
                <h4 className="text-[#e8e4df] font-bold mb-4">US "Humanitarian" Interventions Body Count</h4>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h5 className="text-[#c73032]/80 font-semibold mb-2">Direct Military Actions</h5>
                    <ul className="space-y-1 text-[#e8e4df]/80 text-sm">
              ...
              <div className="bg-[#0d1b2a]/30 rounded-lg p-6">
                ...
                <div className="bg-[#c73032]/10 rounded p-4 border border-[#c73032]/30">
                  ...
                  <p className="text-[#e8e4df]/60 text-sm mt-2">- President Nixon's 1970 directive on Chile</p>
                  <p className="text-[#e8e4df]/80 text-sm mt-2">
        ...
        >
          <div className="space-y-6">
            <div className="bg-[#0d1b2a]/50 rounded-lg p-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-[#1b4965]/20 rounded-lg p-4 border border-[#1b4965]">
                  <h4 className="font-bold text-[#e8e4df] mb-3">What They Demand of Others</h4>
                  <ul className="space-y-2 text-[#e8e4df]/80 text-sm">
                ...
                <div className="bg-[#c73032]/10 rounded-lg p-4 border border-[#c73032]/30">
                  <h4 className="font-bold text-[#e8e4df] mb-3">What They Actually Do</h4>
                  <ul className="space-y-2 text-[#e8e4df]/80 text-sm">
              ...
              <div className="mt-6 bg-[#1b4965]/20 rounded-lg p-6 border border-[#1b4965]">
                ...
                <p className="text-[#e8e4df]/60 text-sm mt-2">- Third World Legal Scholarship</p>
              </div>
            </div>
          </div>
        </Section>
        ...
        <div className="mt-12 bg-[#1b4965]/20 rounded-xl p-8 border border-[#1b4965]">
          <h2 className="text-3xl font-bold text-[#e8e4df] mb-6 text-center">Pattern Recognition: The Receipts Always Tell the Same Story</h2>
          ...
          <div className="bg-[#0d1b2a]/50 rounded-lg p-6">
            <h3 className="text-xl font-bold text-[#e8e4df] mb-4 text-center">The Universal Truth</h3>
            <p className="text-lg text-[#e8e4df]/90 text-center max-w-4xl mx-auto">
        ...
        <div className="mt-8 flex flex-wrap gap-4 justify-center">
          <Link href="/truth-project/power-dynamics" className="px-6 py-3 bg-[#c73032] hover:bg-[#c73032]/80 text-[#e8e4df] font-medium rounded-lg transition-colors">
            Read Power Analysis
          </Link>
          <Link href="/truth-project" className="px-6 py-3 bg-[#1b4965] hover:bg-[#1b4965]/80 text-[#e8e4df] font-medium rounded-lg transition-colors">
            More Investigations
          </Link>
          <Link href="/contact" className="px-6 py-3 bg-[#e8e4df]/10 hover:bg-[#e8e4df]/20 text-[#e8e4df] font-medium rounded-lg transition-colors border border-[#e8e4df]/20">
            Share Your Receipts
          </Link>
        </div>
      </div>
...
function ReceiptCard({
  ...
  return (
    <div className="bg-[#e8e4df]/5 rounded-lg p-4 border border-[#1b4965]/30">
      <div className="grid md:grid-cols-3 gap-4">
        <div>
          <h5 className="font-bold text-[#e8e4df] mb-2">{country}</h5>
          <p className="text-[#1b4965] text-sm font-medium mb-1">The Claim:</p>
          <p className="text-[#e8e4df]/80 text-sm">{claim}</p>
        </div>
        <div>
          <p className="text-[#c73032] text-sm font-medium mb-1">The Reality:</p>
          <p className="text-[#e8e4df]/80 text-sm">{reality}</p>
        </div>
        <div>
          <p className="text-[#d4a74a] text-sm font-medium mb-1">The Receipt:</p>
          <p className="text-[#e8e4df]/60 text-xs">{source}</p>
        </div>
      </div>
    </div>
  )
