...
export const metadata = {
	title: "Truth Project",
	description: "Analysis hub for narrative audits, timelines, and cross-language comparisons.",
	alternates: {
		canonical: "/truth-project",
		languages: {
			"en": "/truth-project",
			"ko-KR": "/truth-project",
			"ko-KP": "/truth-project",
...
export default function TruthProjectIndex() {
	return (
		<main id="main-content" className="min-h-screen bg-background text-foreground">
			<JucheHeader />
			<div className="container mx-auto px-4 py-12">
				<h1 className="text-3xl font-bold mb-4">Truth Project</h1>
				<p className="text-muted-foreground">Explore narrative analyses and primary sources.</p>
			</div>
			<JucheFooter />
		</main>
	)
