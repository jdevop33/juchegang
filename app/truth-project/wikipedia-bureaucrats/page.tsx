  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <header className="mb-12">
        <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 bg-korean-red/20 text-korean-red rounded-full text-sm font-medium">
          <AlertTriangle className="h-4 w-4" />
          Investigative Report
        </div>
        <h1 className="text-4xl md:text-6xl font-bold text-cream mb-6">Wikipedia's Hidden Power: Inside the bureaucrat system</h1>
      ...
      <div className="grid lg:grid-cols-4 gap-8">
        <article className="lg:col-span-3 space-y-8">
          {/* Key Findings */}
          <section className="bg-korean-red/20 border border-korean-red/40 rounded-xl p-6">
            <h2 className="text-2xl font-bold text-korean-red mb-4 flex items-center gap-2">
              <AlertTriangle className="h-5 w-5" />
              Key Findings
            </h2>
            <ul className="space-y-3 text-cream/90">
              <li className="flex items-start gap-3">
                <div className="w-2 h-2 bg-korean-red rounded-full mt-2 flex-shrink-0"></div>
          ...
          <section className="space-y-6">
            ...
            <div className="prose prose-lg prose-invert max-w-none">
              ...
              <div className="bg-cream/5 border border-cream/10 rounded-xl p-6 my-8">
                <h3 className="text-xl font-bold text-cream mb-3">Selection Process</h3>
          ...
          {/* Community theater */}
          <section className="space-y-6">
            <h2 className="text-3xl font-bold text-cream">Selection through community theater masks deeper power dynamics</h2>
            <div className="prose prose-lg prose-invert max-w-none">
              <p className="text-cream/90 leading-relaxed">
              ...
              <div className="bg-river-current/20 border border-river-current/40 rounded-xl p-6 my-8">
                <h3 className="text-xl font-bold text-river-current mb-3">Policy Requirements</h3>
                <p className="text-cream/80">
          ...
          {/* Systemic bias */}
          <section className="space-y-6">
            <h2 className="text-3xl font-bold text-cream">Systemic bias confirmed by academic research and internal scandals</h2>
            <div className="prose prose-lg prose-invert max-w-none">
              <p className="text-cream/90 leading-relaxed">
              ...
              <div className="bg-korean-red/20 border border-korean-red/40 rounded-xl p-6 my-8">
                <h3 className="text-xl font-bold text-korean-red mb-3">Internal Scandals</h3>
            ...
            <div className="prose prose-lg prose-invert max-w-none">
              ...
              <div className="grid md:grid-cols-2 gap-6 my-8">
                <div className="bg-cream/5 border border-cream/10 rounded-xl p-6">
                  <h3 className="text-lg font-bold text-cream mb-3">Global South Representation</h3>
                  <ul className="space-y-2 text-cream/80">
                ...
                <div className="bg-cream/5 border border-cream/10 rounded-xl p-6">
                  <h3 className="text-lg font-bold text-cream mb-3">Bureaucrat Demographics</h3>
                  <ul className="space-y-2 text-cream/80">
          ...
          {/* Failed reforms */}
          <section className="space-y-6">
            <h2 className="text-3xl font-bold text-cream">Failed reforms reveal entrenched resistance to change</h2>
            <div className="prose prose-lg prose-invert max-w-none">
              <p className="text-cream/90 leading-relaxed">
              ...
              <div className="bg-sovereign-gold/20 border border-sovereign-gold/40 rounded-xl p-6 my-8">
                <h3 className="text-xl font-bold text-sovereign-gold mb-3">The Pattern of Reform Failure</h3>
                <p className="text-cream/80">
          ...
          {/* Conclusion */}
          <section className="space-y-6 bg-river-depths/50 border border-river-current/40 rounded-xl p-8">
            <h2 className="text-3xl font-bold text-cream">Conclusion: Concentrated power undermines encyclopedic neutrality</h2>
            <div className="prose prose-lg prose-invert max-w-none">
              <p className="text-cream/90 leading-relaxed">
        ...
        <aside className="space-y-6">
          <div className="bg-river-current/20 border border-river-current/40 rounded-xl p-5">
            <h3 className="text-lg font-semibold text-river-current mb-2">Research Sources</h3>
            <p className="text-cream/80 mb-3 text-sm">Cambridge University study, academic journals, and internal Wikipedia documentation analyzed.</p>
          </div>

          <div className="bg-korean-red/20 border border-korean-red/40 rounded-xl p-5">
            <h3 className="text-lg font-semibold text-korean-red mb-2">Impact Assessment</h3>
          ...
          <div className="bg-river-current/20 border border-river-current/40 rounded-xl p-5">
            <h3 className="text-lg font-semibold text-sovereign-gold mb-2">Share This Investigation</h3>
            <p className="text-cream/80 mb-3 text-sm">Help expose Wikipedia's hidden power structures.</p>
            <Link href="/social" className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-river-current text-cream hover:bg-river-current/80 text-sm">
              Share on Social
            </Link>
          </div>
          ...
          <div className="bg-river-current/20 border border-river-current/40 rounded-xl p-5">
            ...
            <p className="text-cream/80 mb-3 text-sm">More investigative reports exposing hidden power structures.</p>
            <Link href="/truth-project" className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-river-current text-cream hover:bg-river-current/80 text-sm">
              View All Reports
            </Link>
          </div>
        </aside>
