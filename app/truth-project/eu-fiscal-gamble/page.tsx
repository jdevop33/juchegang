    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0d1b2a] via-[#0d1b2a]/90 to-[#0d1b2a]">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <header className="mb-12">
          ...
          <p className="text-xl text-[#f0ebe3]/80 mb-6">
        ...
        <section className="mb-12">
          ...
          <div className="prose prose-invert max-w-none">
            <p className="text-[#f0ebe3]/90 leading-relaxed mb-6">
            ...
            <div className="bg-[#c73032]/20 rounded-xl p-6 border border-[#c73032]/30 mb-6">
              ...
              <div className="space-y-4 text-[#f0ebe3]/90">
                <p>
                  <strong className="text-[#f0ebe3]">Year 2028 onwards:</strong> EU budget assumes
                  approximately &euro;3 billion annually in interest payments on bonds issued to fund the loan.
                </p>
                <p>
                  <strong className="text-[#f0ebe3]">Principal liability:</strong> The full &euro;90 billion
                  becomes an EU budget obligation with no specified repayment timeline.
                </p>
                <p>
                  <strong className="text-[#f0ebe3]">Bond market impact:</strong> Absence of fixed maturity dates
            ...
            <h3 className="text-xl font-bold text-[#f0ebe3] mb-4">Historical Precedent: Reparations Rarely Materialize</h3>
            <p className="text-[#f0ebe3]/90 leading-relaxed mb-6">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <div className="bg-[#d4a74a]/20 rounded-xl p-6 border border-[#d4a74a]/30 mb-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center border-b border-[#f0ebe3]/10 pb-2">
                  <span className="text-[#f0ebe3]/80">NextGenerationEU (2021)</span>
                  <span className="text-[#d4a74a] font-bold">&euro;750B</span>
                </div>
                <div className="flex justify-between items-center border-b border-[#f0ebe3]/10 pb-2">
                  <span className="text-[#f0ebe3]/80">SURE Program</span>
                  <span className="text-[#d4a74a] font-bold">&euro;100B</span>
                </div>
                <div className="flex justify-between items-center border-b border-[#f0ebe3]/10 pb-2">
                  <span className="text-[#f0ebe3]/80">Previous Ukraine Support</span>
                  <span className="text-[#d4a74a] font-bold">&euro;50B+</span>
                </div>
                <div className="flex justify-between items-center border-b border-[#f0ebe3]/10 pb-2">
                  <span className="text-[#f0ebe3]/80">New Ukraine Package</span>
                  <span className="text-[#d4a74a] font-bold">&euro;90B</span>
                </div>
                <div className="flex justify-between items-center pt-2">
                  <span className="text-[#f0ebe3] font-bold">Total EU-Level Exposure</span>
        ...
        {/* Political Economy */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-[#f0ebe3] mb-6">Political Economy Considerations</h2>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <h3 className="text-xl font-bold text-[#f0ebe3] mb-4">Domestic Political Implications</h3>
            <p className="text-[#f0ebe3]/90 leading-relaxed mb-6">
        ...
        <section className="mb-12 bg-gradient-to-r from-[#0d1b2a]/50 to-[#0d1b2a]/50 rounded-xl p-6 border border-[#0d1b2a]/30">
          <h2 className="text-2xl font-bold text-[#f0ebe3] mb-4">Conclusion: Understanding the Stakes</h2>
          <div className="prose prose-invert max-w-none">
        ...
        {/* Sources & Cross-links */}
        <section className="border-t border-[#f0ebe3]/10 pt-8">
          <h2 className="text-xl font-bold text-[#f0ebe3] mb-4">Sources & Further Reading</h2>
          <div className="grid md:grid-cols-2 gap-4 mb-8">
            <div className="bg-[#f0ebe3]/5 rounded-lg p-4">
              <h3 className="font-medium text-[#f0ebe3] mb-2">Primary Sources</h3>
              <ul className="space-y-2 text-sm text-[#f0ebe3]/70">
            ...
            <div className="bg-[#f0ebe3]/5 rounded-lg p-4">
              <h3 className="font-medium text-[#f0ebe3] mb-2">Related Analysis</h3>
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link href="/briefings/eu-ukraine-aid" className="px-6 py-3 bg-[#1b4965] hover:bg-[#1b4965]/80 text-[#f0ebe3] font-medium rounded-lg transition-colors">
              Read the Briefing Version
            </Link>
            <Link href="/truth-project" className="px-6 py-3 bg-[#f0ebe3]/10 hover:bg-[#f0ebe3]/20 text-[#f0ebe3] font-medium rounded-lg transition-colors border border-[#f0ebe3]/20">
