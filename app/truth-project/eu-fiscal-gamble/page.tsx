...
export default function EUFiscalGamblePage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0d1b2a] via-[#0d1b2a]/90 to-[#0d1b2a]">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <header className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            <span className="px-3 py-1 bg-[#c73032]/20 text-[#c73032] text-xs font-medium rounded-full border border-[#c73032]/30">
              Truth Project
            </span>
            <span className="px-3 py-1 bg-[#1b4965]/20 text-[#1b4965] text-xs font-medium rounded-full border border-[#1b4965]/30">
              Fiscal Analysis
            </span>
          </div>
          ...
          <p className="text-xl text-[#e8e4df]/80 mb-6">
          ...
          <div className="flex items-center gap-4 text-sm text-[#e8e4df]/60">
        ...
        {/* Executive Summary */}
        <section className="mb-12 bg-gradient-to-r from-[#1b4965]/20 to-[#d4a74a]/20 rounded-xl p-6 border border-[#1b4965]/30">
          <h2 className="text-xl font-bold text-[#1b4965] mb-4 flex items-center gap-2">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-[#e8e4df] mb-6 flex items-center gap-2">
            <TrendingDown className="w-6 h-6 text-[#c73032]" />
            The Mathematics of Risk Transfer
          </h2>

          <div className="prose prose-invert max-w-none">
            <p className="text-[#e8e4df]/90 leading-relaxed mb-6">
            ...
            <div className="bg-[#c73032]/20 rounded-xl p-6 border border-[#c73032]/30 mb-6">
              <h3 className="text-lg font-bold text-[#c73032] mb-4 flex items-center gap-2">
                <AlertTriangle className="w-5 h-5" />
                Scenario Analysis: If Reparations Never Come
              </h3>
              <div className="space-y-4 text-[#e8e4df]/90">
                <p>
                  <strong className="text-[#e8e4df]">Year 2028 onwards:</strong> EU budget assumes
                  approximately &euro;3 billion annually in interest payments on bonds issued to fund the loan.
                </p>
                <p>
                  <strong className="text-[#e8e4df]">Principal liability:</strong> The full &euro;90 billion
                  becomes an EU budget obligation with no specified repayment timeline.
                </p>
                <p>
                  <strong className="text-[#e8e4df]">Bond market impact:</strong> Absence of fixed maturity dates
            ...
            <h3 className="text-xl font-bold text-[#e8e4df] mb-4">Historical Precedent: Reparations Rarely Materialize</h3>
            <p className="text-[#e8e4df]/90 leading-relaxed mb-6">
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-6">
              <div className="bg-[#d4a74a]/20 rounded-lg p-4 border border-[#d4a74a]/30">
                <h4 className="font-bold text-[#d4a74a] mb-2">WWI German Reparations</h4>
              ...
              <div className="bg-[#d4a74a]/20 rounded-lg p-4 border border-[#d4a74a]/30">
                <h4 className="font-bold text-[#d4a74a] mb-2">Iraq Gulf War Reparations</h4>
                <p className="text-[#e8e4df]/80 text-sm">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-[#e8e4df] mb-6 flex items-center gap-2">
            <Scale className="w-6 h-6 text-[#d4a74a]" />
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <div className="bg-[#d4a74a]/20 rounded-xl p-6 border border-[#d4a74a]/30 mb-6">
              <h3 className="font-bold text-[#d4a74a] mb-4">EU-Level Debt Obligations</h3>
              <div className="space-y-3">
                <div className="flex justify-between items-center border-b border-[#e8e4df]/10 pb-2">
                  <span className="text-[#e8e4df]/80">NextGenerationEU (2021)</span>
                  <span className="text-[#d4a74a] font-bold">&euro;750B</span>
                </div>
                <div className="flex justify-between items-center border-b border-[#e8e4df]/10 pb-2">
                  <span className="text-[#e8e4df]/80">SURE Program</span>
                  <span className="text-[#d4a74a] font-bold">&euro;100B</span>
                </div>
                <div className="flex justify-between items-center border-b border-[#e8e4df]/10 pb-2">
                  <span className="text-[#e8e4df]/80">Previous Ukraine Support</span>
                  <span className="text-[#d4a74a] font-bold">&euro;50B+</span>
                </div>
                <div className="flex justify-between items-center border-b border-[#e8e4df]/10 pb-2">
                  <span className="text-[#e8e4df]/80">New Ukraine Package</span>
                  <span className="text-[#d4a74a] font-bold">&euro;90B</span>
                </div>
                <div className="flex justify-between items-center pt-2">
                  <span className="text-[#e8e4df] font-bold">Total EU-Level Exposure</span>
                  <span className="text-[#c73032] font-bold text-xl">&euro;990B+</span>
                </div>
              </div>
            </div>
        ...
        {/* Political Economy */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-[#e8e4df] mb-6">Political Economy Considerations</h2>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <div className="bg-[#d4a74a]/20 rounded-xl p-6 border border-[#d4a74a]/30 mb-6">
              <h3 className="font-bold text-[#d4a74a] mb-4">The Opt-Out Calculation</h3>
            ...
            <h3 className="text-xl font-bold text-[#e8e4df] mb-4">Domestic Political Implications</h3>
            <p className="text-[#e8e4df]/90 leading-relaxed mb-6">
        ...
        {/* Conclusion */}
        <section className="mb-12 bg-gradient-to-r from-[#0d1b2a]/50 to-[#0d1b2a]/50 rounded-xl p-6 border border-[#0d1b2a]/30">
          <h2 className="text-2xl font-bold text-[#e8e4df] mb-4">Conclusion: Understanding the Stakes</h2>
          <div className="prose prose-invert max-w-none">
            <p className="text-[#e8e4df]/90 leading-relaxed mb-4">
        ...
        {/* Sources & Cross-links */}
        <section className="border-t border-[#e8e4df]/10 pt-8">
          <h2 className="text-xl font-bold text-[#e8e4df] mb-4">Sources & Further Reading</h2>
          <div className="grid md:grid-cols-2 gap-4 mb-8">
            <div className="bg-[#e8e4df]/5 rounded-lg p-4">
              <h3 className="font-medium text-[#e8e4df] mb-2">Primary Sources</h3>
              <ul className="space-y-2 text-sm text-[#e8e4df]/70">
            ...
            <div className="bg-[#e8e4df]/5 rounded-lg p-4">
              <h3 className="font-medium text-[#e8e4df] mb-2">Related Analysis</h3>
              <ul className="space-y-2 text-sm">
                <li>
                  <Link href="/briefings/eu-ukraine-aid" className="text-[#1b4965] hover:text-[#1b4965]/80 flex items-center gap-1">
                    EU Ukraine Aid: Quick Briefing <ExternalLink className="w-3 h-3" />
                  </Link>
                </li>
                <li>
                  <Link href="/briefings/sanctions-warfare" className="text-[#1b4965] hover:text-[#1b4965]/80 flex items-center gap-1">
                    Sanctions Warfare Analysis <ExternalLink className="w-3 h-3" />
                  </Link>
                </li>
                <li>
                  <Link href="/truth-project/sovereign-wealth-seizures" className="text-[#1b4965] hover:text-[#1b4965]/80 flex items-center gap-1">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link href="/briefings/eu-ukraine-aid" className="px-6 py-3 bg-[#1b4965] hover:bg-[#1b4965]/80 text-[#e8e4df] font-medium rounded-lg transition-colors">
              Read the Briefing Version
            </Link>
            <Link href="/truth-project" className="px-6 py-3 bg-[#e8e4df]/10 hover:bg-[#e8e4df]/20 text-[#e8e4df] font-medium rounded-lg transition-colors border border-[#e8e4df]/20">
