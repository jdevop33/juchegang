    ...
    <div className="min-h-screen bg-gradient-to-b from-river-depths via-river-deep to-river-depths flex items-center justify-center px-4">
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link 
            href="/truth-project" 
            className="inline-flex items-center gap-2 px-6 py-3 bg-river-current hover:bg-river-current text-cream font-medium rounded-lg transition-colors"
          >
            View Truth Project
          </Link>
        </div>
        ...
        <div className="mt-12 p-6 bg-cream/5 rounded-lg border border-cream/10">
          ...
          <div className="grid sm:grid-cols-2 gap-3 text-left">
            ...
            <Link href="/social" className="text-cream/70 hover:text-cream transition-colors">
              🌐 Social Media
            </Link>
            <Link href="/briefings" className="text-cream/70 hover:text-cream transition-colors">
              📄 Briefings
            </Link>
