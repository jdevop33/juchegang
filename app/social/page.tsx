    ...
    <>
      ...
      <div className="container mx-auto px-4 py-10">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-semibold text-[#f0ebe3] mb-4">Instagram</h2>
          <div className="flex flex-wrap gap-4 mb-6">
            <a
              href="https://instagram.com/jpandajames39"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-[#c73032] to-[#d4a74a] text-[#f0ebe3] rounded-lg hover:from-[#a82729] hover:to-[#b8923f] transition-colors"
            >
          ...
          {ig.length === 0 ? (
            <p className="text-[#f0ebe3]/60">Instagram feed integration coming soon. Follow us on Instagram for the latest updates!</p>
          ) : (
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {ig.map((p) => (
                <a key={p.id} href={p.permalink} target="_blank" className="block rounded-lg overflow-hidden border border-[#1b4965] bg-[#0d1b2a]/50 hover:bg-[#1b4965]/40">
                  ...
                  <div className="p-4">
                    <p className="text-[#f0ebe3]/80 text-sm line-clamp-2">{p.caption}</p>
                    <p className="text-[#f0ebe3]/50 text-xs mt-1">{new Date(p.timestamp).toLocaleString()}</p>
                  </div>
                </a>
              ))}
            </div>
