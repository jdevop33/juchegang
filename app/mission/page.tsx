      ...
      <section className="relative py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          >
            ...
            {language !== 'kr' && (
              <p className="text-lg text-[#d4a74a]/80 mt-4 font-[family-name:var(--font-korean)]">
                우리의 사명: 평화와 통일을 향한 길
              </p>
            )}
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-gradient-to-r from-[#1b4965]/50 to-[#1b4965]/30 rounded-2xl p-8 mb-16 border border-[#1b4965]"
          >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {principles.map((principle, index) => (
              ...
              >
                <Card className="bg-[#0d1b2a]/80 border-[#1b4965] hover:border-[#d4a74a]/50 transition-all duration-300 h-full">
          ...
          <motion.div
            ...
            className="text-center bg-gradient-to-r from-[#1b4965]/30 to-[#1b4965]/20 rounded-2xl p-12 border border-[#d4a74a]/30"
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="#contact"
                className="inline-flex items-center px-8 py-4 border-2 border-[#d4a74a] text-[#d4a74a] hover:bg-[#d4a74a] hover:text-[#0d1b2a] font-bold rounded-lg transition-all duration-300 transform hover:scale-105"
              >
          ...
          >
            <blockquote className="text-2xl md:text-3xl text-[#d4a74a] italic font-light font-[family-name:var(--font-korean)]">
              {language === 'kr'
